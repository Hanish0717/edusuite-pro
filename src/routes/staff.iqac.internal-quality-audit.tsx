...
export const Route = createFileRoute("/staff/iqac/internal-quality-audit")({
  head: () => ({
    meta: [{ title: "Internal Quality Audit — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Internal Quality Audit</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Internal Audits" value="12 Inspections" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Lab Score" value="98.2%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Compliance Rate" value="100%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Internal Quality Audit Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Inspection ID</th><th className="p-3">Department / Lab</th><th className="p-3">Inspector Name</th><th className="p-3">Score</th><th className="p-3">Audit Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
