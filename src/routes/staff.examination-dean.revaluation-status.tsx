...
export const Route = createFileRoute("/staff/examination-dean/revaluation-status")({
  head: () => ({
    meta: [{ title: "Revaluation Status — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Revaluation Status</h1>
          <p className="text-sm text-muted-foreground">Re-evaluation valuation camp progress and independent re-checker marks.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Re-evaluated" value="10 / 14 Scripts" icon={Users} tone="purple" />
        <KpiCard label="Marks Updated" value="6 Students" icon={Calendar} tone="success" />
        <KpiCard label="Re-checker SLA" value="Completed" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Revaluation Status Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Application ID</th><th className="p-3">Student Name</th><th className="p-3">Subject Code</th><th className="p-3">Re-Evaluator Name</th><th className="p-3">Updated Marks</th><th className="p-3">Status</th>
                </tr>
              </thead>
