...
export const Route = createFileRoute("/staff/finance-dean/audit-reports")({
  head: () => ({
    meta: [{ title: "Audit Reports — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Internal & external statutory audit reports and compliance ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Audits Cleared" value="100%" icon={Wallet} tone="purple" />
        <KpiCard label="CAG Certificate" value="Issued" icon={CreditCard} tone="success" />
        <KpiCard label="Objection Count" value="Zero" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Audit Reports Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Auditor Name</th><th className="p-3">Audit Opinion</th><th className="p-3">Status</th>
                </tr>
              </thead>
