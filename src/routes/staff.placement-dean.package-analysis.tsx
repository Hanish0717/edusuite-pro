...
export const Route = createFileRoute("/staff/placement-dean/package-analysis")({
  head: () => ({
    meta: [{ title: "Package Analysis — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Package Analysis</h1>
          <p className="text-sm text-muted-foreground">CTC band distribution analysis, base pay vs variable pay ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Highest CTC" value="₹52.0 LPA" icon={Building2} tone="purple" />
        <KpiCard label="Average CTC" value="₹12.4 LPA" icon={Users} tone="success" />
        <KpiCard label="Median CTC" value="₹10.5 LPA" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Package Analysis Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">CTC Band Range</th><th className="p-3">Total Placed Students</th><th className="p-3">Percentage Share</th><th className="p-3">Top Recruiter in Band</th><th className="p-3">Status</th>
                </tr>
              </thead>
