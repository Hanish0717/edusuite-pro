...
export const Route = createFileRoute("/staff/placement-dean/coding-training")({
  head: () => ({
    meta: [{ title: "Coding Training — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Coding Training</h1>
          <p className="text-sm text-muted-foreground">Data Structures, Algorithms, System Design, and LeetCode bootcamp.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Coding Bootcamps" value="150 Hours" icon={Building2} tone="purple" />
        <KpiCard label="Problems Solved Avg" value="250 Problems" icon={Users} tone="success" />
        <KpiCard label="Mock OA Clear Rate" value="92.0%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Coding Training Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Program Title</th><th className="p-3">Lead Trainer</th><th className="p-3">Target Companies</th><th className="p-3">Coverage</th><th className="p-3">Student Rating</th><th className="p-3">Status</th>
                </tr>
              </thead>
