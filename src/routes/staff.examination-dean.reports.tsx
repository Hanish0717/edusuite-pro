...
export const Route = createFileRoute("/staff/examination-dean/reports")({
  head: () => ({
    meta: [{ title: "Examination Reports & Analysis — EduSuite Pro" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Examination Reports & Analysis</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Reports" value="14 Reports" icon={Building2} tone="info" />
        <KpiCard label="Pass Rate" value="92.6%" icon={Users} tone="success" />
        <KpiCard label="SLA Compliance" value="100%" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="Examination Reports & Analysis Ledger" description="Official domain records & ERP status.">
