...
export const Route = createFileRoute("/staff/ima/laboratory-reports")({
  head: () => ({
    meta: [{ title: "Laboratory Reports — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Laboratory Reports</h1>
          <p className="text-sm text-muted-foreground">Lab utilization reports, seating capacity, and inspection audits.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Reports Generated" value="18 Reports" icon={FlaskConical} tone="purple" />
        <KpiCard label="Lab Utilization" value="84.2%" icon={Cpu} tone="success" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Laboratory Reports Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
