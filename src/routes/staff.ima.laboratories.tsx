...
export const Route = createFileRoute("/staff/ima/laboratories")({
  head: () => ({
    meta: [{ title: "Laboratories — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Laboratories</h1>
          <p className="text-sm text-muted-foreground">Master list of campus labs, seating capacity, systems, and incharge faculty.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Labs" value="18 Labs" icon={FlaskConical} tone="purple" />
        <KpiCard label="Total Systems" value="720 PCs" icon={Cpu} tone="success" />
        <KpiCard label="Avg Capacity" value="40 Seats" icon={Wrench} tone="info" />
        <KpiCard label="Status" value="Operational" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Laboratories Distribution Chart" description="Quantitative inventory and equipment breakdown.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Laboratories Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Lab Code</th><th className="p-3">Lab Name</th><th className="p-3">Department</th><th className="p-3">Faculty Incharge</th><th className="p-3">Capacity</th><th className="p-3">Systems</th><th className="p-3">Location</th><th className="p-3">Status</th>
                </tr>
              </thead>
