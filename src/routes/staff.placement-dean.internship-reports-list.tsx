...
export const Route = createFileRoute("/staff/placement-dean/internship-reports-list")({
  head: () => ({
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Summer internship performance ledgers and corporate stipend audit.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Internships" value="420 Students" icon={Building2} tone="purple" />
        <KpiCard label="Stipend Total" value="₹1.85 Cr" icon={Users} tone="success" />
        <KpiCard label="PPO Rate" value="65%" icon={Briefcase} tone="info" />
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Total Interns</th><th className="p-3">Stipend Disbursed</th><th className="p-3">Status</th>
                </tr>
              </thead>
