...
export const Route = createFileRoute("/staff/examination-dean/malpractice-reports")({
  head: () => ({
    meta: [{ title: "Malpractice Reports — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Malpractice Reports</h1>
          <p className="text-sm text-muted-foreground">Malpractice incident ledgers, squad inspection reports, and committee actions.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Malpractice Rate" value="0.03%" icon={Users} tone="purple" />
        <KpiCard label="Disciplinary Actions" value="100% Enforced" icon={Calendar} tone="success" />
        <KpiCard label="Squad Inspections" value="36 Runs" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Malpractice Reports Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Cases Reported</th><th className="p-3">Committee Enforcement</th><th className="p-3">Status</th>
                </tr>
              </thead>
