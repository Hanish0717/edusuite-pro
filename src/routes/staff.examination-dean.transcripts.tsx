...
export const Route = createFileRoute("/staff/examination-dean/transcripts")({
  head: () => ({
    meta: [{ title: "Official Transcripts & Degree Audit — EduSuite Pro" }],
  }),
...
function SubPageComponent() {
  ...
  const rawItems = useMemo(() => {
    return [ { id: 'TRN-2026-901', student: 'K. Sai Teja', roll: '22CS101', cgpa: '9.42 CGPA', status: 'Issued' }, { id: 'TRN-2026-902', student: 'Ananya Roy', roll: '22EC104', cgpa: '9.18 CGPA', status: 'Issued' } ];
  }, [data]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Official Transcripts & Degree Audit</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Transcripts Issued" value="640 Issued" icon={Building2} tone="info" />
        <KpiCard label="Degree Audits" value="Complete" icon={Users} tone="success" />
        <KpiCard label="Digital Verification" value="100%" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Verified" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="Official Transcripts & Degree Audit Ledger" description="Official domain records & ERP status.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Transcript ID</th><th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Final CGPA</th><th className="p-3">Status</th>
                </tr>
              </thead>
