...
export const Route = createFileRoute("/staff/examination-dean/practical-exams")({
  head: () => ({
    meta: [{ title: "Practical Exams — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Practical Exams</h1>
          <p className="text-sm text-muted-foreground">Laboratory practical examinations, external examiner appointments, and viva.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Lab Exams" value="48 Lab Exams" icon={Users} tone="purple" />
        <KpiCard label="External Examiners" value="24 External Faculty" icon={Calendar} tone="success" />
        <KpiCard label="Marks Entry" value="100%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Practical Exams Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Lab Code</th><th className="p-3">Practical Subject Title</th><th className="p-3">Department</th><th className="p-3">External Examiner</th><th className="p-3">Exam Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
