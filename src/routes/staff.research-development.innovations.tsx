...
export const Route = createFileRoute("/staff/research-development/innovations")({
  head: () => ({
    meta: [{ title: "Innovations — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Innovations</h1>
          <p className="text-sm text-muted-foreground">Institutional student & faculty innovative prototypes & TRL levels.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Prototypes" value="32 Innovations" icon={FolderGit2} tone="purple" />
        <KpiCard label="TRL Level 7-9" value="12 Projects" icon={BookOpen} tone="success" />
        <KpiCard label="Commercial Target" value="8 Projects" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Innovations Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Innovation Code</th><th className="p-3">Innovation Title</th><th className="p-3">Lead Innovator</th><th className="p-3">TRL Stage</th><th className="p-3">Domain</th><th className="p-3">Status</th>
                </tr>
              </thead>
