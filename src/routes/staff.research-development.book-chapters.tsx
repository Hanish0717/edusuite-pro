...
export const Route = createFileRoute("/staff/research-development/book-chapters")({
  head: () => ({
    meta: [{ title: "Book Chapters — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Book Chapters</h1>
          <p className="text-sm text-muted-foreground">Authored books and Springer/CRC Press book chapters.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Book Chapters" value="42 Chapters" icon={FolderGit2} tone="purple" />
        <KpiCard label="Authored Books" value="8 Books" icon={BookOpen} tone="success" />
        <KpiCard label="Publishers" value="Springer / CRC" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Book Chapters Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Chapter Title</th><th className="p-3">Book Title</th><th className="p-3">Authors</th><th className="p-3">Publisher</th><th className="p-3">ISBN</th><th className="p-3">Year</th><th className="p-3">Status</th>
                </tr>
              </thead>
