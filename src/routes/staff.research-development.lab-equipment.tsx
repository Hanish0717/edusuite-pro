...
export const Route = createFileRoute("/staff/research-development/lab-equipment")({
  head: () => ({
    meta: [{ title: "Lab Equipment — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Lab Equipment</h1>
          <p className="text-sm text-muted-foreground">High-end R&D equipment, Spectrum Analyzers, and GPU Servers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="High-End Assets" value="64 Assets" icon={FolderGit2} tone="purple" />
        <KpiCard label="Valuation" value="₹3.20 Cr" icon={BookOpen} tone="success" />
        <KpiCard label="Working" value="100%" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Lab Equipment Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Asset Code</th><th className="p-3">Equipment Description</th><th className="p-3">Laboratory</th><th className="p-3">Brand & Model</th><th className="p-3">Cost</th><th className="p-3">Status</th>
                </tr>
              </thead>
