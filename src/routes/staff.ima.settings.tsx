...
export const Route = createFileRoute("/staff/ima/settings")({
  head: () => ({
    meta: [{ title: "IMA Portal Settings — EduSuite Pro" }],
  }),
...
function SubPageComponent() {
  ...
  const rawItems = useMemo(() => {
    return [ { name: 'Campus Safety Officer', val: 'Col. R. S. Rathore', date: '2026-01-10', status: 'Active' } ];
  }, [data]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">IMA Portal Settings</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="IMA Dean" value="Prof. IMA Dean" icon={Building2} tone="info" />
        <KpiCard label="Asset Threshold" value="₹50,000" icon={Users} tone="success" />
      ...
      <Panel title="IMA Portal Settings Ledger" description="Official domain records & ERP status.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Parameter Name</th><th className="p-3">Configured Value</th><th className="p-3">Last Updated</th><th className="p-3">Status</th>
                </tr>
              </thead>
