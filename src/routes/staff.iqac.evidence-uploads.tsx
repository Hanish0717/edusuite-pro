...
export const Route = createFileRoute("/staff/iqac/evidence-uploads")({
  head: () => ({
    meta: [{ title: "Evidence Uploads — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Evidence Uploads</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Uploaded Files" value="2,450 Evidences" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Dept Approvals" value="100% Cleared" icon={ShieldCheck} tone="success" />
        <KpiCard label="Audit Pass" value="Verified" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Evidence Uploads Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Evidence Tag</th><th className="p-3">Evidence Title</th><th className="p-3">Department</th><th className="p-3">Uploaded Date</th><th className="p-3">Approval Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
