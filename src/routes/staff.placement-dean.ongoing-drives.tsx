...
export const Route = createFileRoute("/staff/placement-dean/ongoing-drives")({
  head: () => ({
    meta: [{ title: "Ongoing Drives — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Ongoing Drives</h1>
          <p className="text-sm text-muted-foreground">Live recruitment drive progress, online assessment monitoring, and interview shortlists.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Live Drives" value="4 Active Drives" icon={Building2} tone="purple" />
        <KpiCard label="Students Testing" value="680 Students" icon={Users} tone="success" />
        <KpiCard label="Live Round" value="Round 2 Tech Interview" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Ongoing Drives Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Current Round</th><th className="p-3">Venue / Platform</th><th className="p-3">Students Appearing</th><th className="p-3">Shortlisted</th><th className="p-3">Status</th>
                </tr>
              </thead>
