...
export const Route = createFileRoute("/staff/research-development/seminars")({
  head: () => ({
    meta: [{ title: "Seminars — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Seminars</h1>
          <p className="text-sm text-muted-foreground">Distinguished R&D expert lecture series and doctoral seminars.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Seminars" value="16 Lectures" icon={FolderGit2} tone="purple" />
        <KpiCard label="Keynote Speakers" value="16 Experts" icon={BookOpen} tone="success" />
        <KpiCard label="Attendance" value="100%" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Seminars Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Seminar Title</th><th className="p-3">Keynote Speaker</th><th className="p-3">Organization</th><th className="p-3">Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
