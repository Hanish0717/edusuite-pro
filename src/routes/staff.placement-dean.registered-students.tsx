...
export const Route = createFileRoute("/staff/placement-dean/registered-students")({
  head: () => ({
    meta: [{ title: "Registered Students — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Registered Students</h1>
          <p className="text-sm text-muted-foreground">Placement portal registered students, resume uploads, and tier choices.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Registered" value="1,820 / 1,850 (98.3%)" icon={Building2} tone="purple" />
        <KpiCard label="Resumes Uploaded" value="100%" icon={Users} tone="success" />
        <KpiCard label="Portal NOC" value="Clear" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Registered" icon={Award} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Registered Students Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Department</th><th className="p-3">Target Domain</th><th className="p-3">Resume Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
