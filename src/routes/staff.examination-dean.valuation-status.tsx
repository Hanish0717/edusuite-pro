...
export const Route = createFileRoute("/staff/examination-dean/valuation-status")({
  head: () => ({
    meta: [{ title: "Valuation Status — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Valuation Status</h1>
          <p className="text-sm text-muted-foreground">Valuation camp progress tracking, evaluated scripts count, and pending bundles.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Scripts Evaluated" value="21,950 / 24,800 (88.5%)" icon={Users} tone="purple" />
        <KpiCard label="Camp Completion" value="88.5%" icon={Calendar} tone="success" />
        <KpiCard label="Camp SLA" value="On-Time" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Valuation Status Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Evaluator Name</th><th className="p-3">Subject Code</th><th className="p-3">Allocated Scripts</th><th className="p-3">Evaluated Count</th><th className="p-3">Pending Count</th><th className="p-3">Status</th>
                </tr>
              </thead>
