...
export function ApprovalWorkflowsPage() {
  ...
  const handleApprove = (id: string) => {
    setWorkflows((prev) => processWorkflowStep(prev, id, "approve", "Authorized Approver", role));
    toast.success(`Workflow step for ${id} approved successfully!`);
  };

  const handleReject = (id: string) => {
    setWorkflows((prev) => processWorkflowStep(prev, id, "reject", "Authorized Approver", role));
