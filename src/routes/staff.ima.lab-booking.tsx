...
export const Route = createFileRoute("/staff/ima/lab-booking")({
  head: () => ({
    meta: [{ title: "Lab Booking — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Lab Booking</h1>
          <p className="text-sm text-muted-foreground">Faculty lab reservation requests, workshops, and exam booking calendar.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Pending Reqs" value="4 Requests" icon={FlaskConical} tone="purple" />
        <KpiCard label="Approved" value="28 Bookings" icon={Cpu} tone="success" />
        <KpiCard label="Next Event" value="Hackathon 2026" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Lab Booking Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Booking Ref</th><th className="p-3">Faculty Name</th><th className="p-3">Laboratory</th><th className="p-3">Event / Reason</th><th className="p-3">Date & Time</th><th className="p-3">Approval Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
