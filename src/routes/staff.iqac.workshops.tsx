...
export const Route = createFileRoute("/staff/iqac/workshops")({
  head: () => ({
    meta: [{ title: "Workshops & FDPs — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Workshops & FDPs</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="FDPs Organized" value="14 Workshops" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Faculty Participants" value="245 Faculty" icon={ShieldCheck} tone="success" />
        <KpiCard label="Outcome Score" value="4.88 / 5" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Workshops & FDPs Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Program Title</th><th className="p-3">Category</th><th className="p-3">Date</th><th className="p-3">Participants</th><th className="p-3">Status</th>
                </tr>
              </thead>
