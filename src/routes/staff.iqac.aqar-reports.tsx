...
export const Route = createFileRoute("/staff/iqac/aqar-reports")({
  head: () => ({
    meta: [{ title: "AQAR Reports — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">AQAR Reports</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="AQAR Filings" value="5 Years" icon={BadgeCheck} tone="purple" />
        <KpiCard label="NAAC Clearance" value="Approved" icon={ShieldCheck} tone="success" />
        <KpiCard label="Filing Status" value="Verified" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="AQAR Reports Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Filing Period</th><th className="p-3">Submission Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
