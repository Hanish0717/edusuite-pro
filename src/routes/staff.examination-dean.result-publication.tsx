...
export const Route = createFileRoute("/staff/examination-dean/result-publication")({
  head: () => ({
    meta: [{ title: "Result Publication — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Result Publication</h1>
          <p className="text-sm text-muted-foreground">Official result publication portal, web portal release, and SMS alert dispatch.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Published Date" value="04-Aug-2026" icon={Users} tone="purple" />
        <KpiCard label="Portal Release" value="Active Live" icon={Calendar} tone="success" />
        <KpiCard label="SMS Dispatched" value="100%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Result Publication Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Result Title</th><th className="p-3">Academic Session</th><th className="p-3">Publication Date</th><th className="p-3">Access Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
