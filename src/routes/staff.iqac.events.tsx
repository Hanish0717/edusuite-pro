...
export const Route = createFileRoute("/staff/iqac/events")({
  head: () => ({
    meta: [{ title: "Institutional Events — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Institutional Events</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Quality Events" value="8 Events" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Participants" value="1,200+" icon={ShieldCheck} tone="success" />
        <KpiCard label="Next Visit" value="18 Aug 2026" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Institutional Events Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Event Title</th><th className="p-3">Event Category</th><th className="p-3">Scheduled Date</th><th className="p-3">Venue</th><th className="p-3">Status</th>
                </tr>
              </thead>
