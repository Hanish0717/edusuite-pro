...
export const Route = createFileRoute("/staff/research-development/publications-repo")({
  head: () => ({
    meta: [{ title: "Publications Repository — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Publications Repository</h1>
          <p className="text-sm text-muted-foreground">Central repository of all institutional publication PDFs & DOIs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Repository Size" value="522 Papers" icon={FolderGit2} tone="purple" />
        <KpiCard label="Citations Total" value="4,850 Count" icon={BookOpen} tone="success" />
        <KpiCard label="h-index Avg" value="18.4 Index" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Publications Repository Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Doc ID</th><th className="p-3">Paper Title</th><th className="p-3">Department</th><th className="p-3">Index Type</th><th className="p-3">Download Link</th><th className="p-3">Status</th>
                </tr>
              </thead>
