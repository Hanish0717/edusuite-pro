...
export const Route = createFileRoute("/staff/research-development/lab-utilization")({
  head: () => ({
    meta: [{ title: "Lab Utilization — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Lab Utilization</h1>
          <p className="text-sm text-muted-foreground">Research lab compute usage, GPU hours logged, and efficiency statistics.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="GPU Hours Logged" value="4,850 Hours" icon={FolderGit2} tone="purple" />
        <KpiCard label="Utilization Rate" value="92.4%" icon={BookOpen} tone="success" />
        <KpiCard label="Audit Pass" value="100%" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Lab Utilization Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Laboratory Name</th><th className="p-3">Weekly Hours Logged</th><th className="p-3">Active Scholars</th><th className="p-3">Efficiency Score</th><th className="p-3">Status</th>
                </tr>
              </thead>
