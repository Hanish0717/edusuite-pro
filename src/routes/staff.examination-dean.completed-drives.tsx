...
export const Route = createFileRoute("/staff/examination-dean/completed-drives")({
  head: () => ({
    meta: [{ title: "Completed Drives — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Completed Drives</h1>
          <p className="text-sm text-muted-foreground">Completed recruitment drive ledgers, total selections, and package announcements.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Completed Drives" value="42 Drives" icon={Building2} tone="purple" />
        <KpiCard label="Total Selections" value="1,640 Offers" icon={Users} tone="success" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Completed Drives Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Drive Date</th><th className="p-3">Total Offers</th><th className="p-3">Highest CTC</th><th className="p-3">Average CTC</th><th className="p-3">Status</th>
                </tr>
              </thead>
