...
export const Route = createFileRoute("/staff/iqac/document-repo")({
  head: () => ({
    meta: [{ title: "Document Repository — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Document Repository</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Documents" value="480 Files" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Categories" value="12 Categories" icon={ShieldCheck} tone="success" />
        <KpiCard label="Version Control" value="v2026.2" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Document Repository Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Category</th><th className="p-3">Document Name</th><th className="p-3">Upload Date</th><th className="p-3">Version</th><th className="p-3">Status</th>
                </tr>
              </thead>
