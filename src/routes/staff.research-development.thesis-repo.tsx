...
export const Route = createFileRoute("/staff/research-development/thesis-repo")({
  head: () => ({
    meta: [{ title: "Thesis Repository — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Thesis Repository</h1>
          <p className="text-sm text-muted-foreground">Submitted PhD dissertations, Shodhganga uploads, and viva records.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Theses Archived" value="68 Dissertations" icon={FolderGit2} tone="purple" />
        <KpiCard label="Shodhganga Upload" value="100%" icon={BookOpen} tone="success" />
        <KpiCard label="Viva Cleared" value="68 Scholars" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Thesis Repository Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Thesis ID</th><th className="p-3">Scholar Name</th><th className="p-3">Thesis Title</th><th className="p-3">Guide Name</th><th className="p-3">Viva Date</th><th className="p-3">Shodhganga Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
