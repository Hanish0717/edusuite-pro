  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Director IQAC" value="Prof. Anand Kumar" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Committee Roster" value="15 Members" icon={ShieldCheck} tone="success" />
        <KpiCard label="NAAC Benchmark" value="3.50 CGPA" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Settings Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
