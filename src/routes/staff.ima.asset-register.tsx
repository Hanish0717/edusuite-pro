...
export const Route = createFileRoute("/staff/ima/asset-register")({
  head: () => ({
    meta: [{ title: "Asset Register — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Asset Register</h1>
          <p className="text-sm text-muted-foreground">Master capital asset register, asset tags, valuation, and purchase ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Capital Valuation" value="₹4.82 Cr" icon={FlaskConical} tone="purple" />
        <KpiCard label="Total Assets" value="1,240 Assets" icon={Cpu} tone="success" />
        <KpiCard label="Audit Clearance" value="100%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Asset Register Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Asset Tag</th><th className="p-3">Asset Name</th><th className="p-3">Category</th><th className="p-3">Department</th><th className="p-3">Purchase Cost</th><th className="p-3">Current Valuation</th><th className="p-3">Status</th>
                </tr>
              </thead>
