...
export const Route = createFileRoute("/staff/research-development/workshops")({
  head: () => ({
    meta: [{ title: "Workshops — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Workshops</h1>
          <p className="text-sm text-muted-foreground">Hands-on research workshops on Patent Filing & Grant Writing.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Workshops" value="12 Workshops" icon={FolderGit2} tone="purple" />
        <KpiCard label="Attendees" value="650 Attendees" icon={BookOpen} tone="success" />
        <KpiCard label="Patents Drafted" value="14 Drafts" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Workshops Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Workshop Title</th><th className="p-3">Focus Area</th><th className="p-3">Date</th><th className="p-3">Resource Person</th><th className="p-3">Status</th>
                </tr>
              </thead>
