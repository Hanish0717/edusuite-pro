...
export const Route = createFileRoute("/staff/iqac/academic-audit")({
  head: () => ({
    meta: [{ title: "Academic Audit — IQAC Dean" }],
  }),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Audits" value="24 Audits" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Avg Score" value="4.82 / 5" icon={ShieldCheck} tone="success" />
        <KpiCard label="Recommendations" value="38 Implemented" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Academic Audit Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Audit Ref</th><th className="p-3">Department</th><th className="p-3">Audit Type</th><th className="p-3">Audit Score</th><th className="p-3">Lead Auditor</th><th className="p-3">Status</th>
                </tr>
              </thead>
