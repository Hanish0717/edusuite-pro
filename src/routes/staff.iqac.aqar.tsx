...
export const Route = createFileRoute("/staff/iqac/aqar")({
  head: () => ({
    meta: [{ title: "AQAR Management — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">AQAR Management</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="AQAR Status" value="Submitted" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Academic Year" value="2025-26" icon={ShieldCheck} tone="success" />
        <KpiCard label="NAAC Approval" value="Clean Pass" icon={FileText} tone="info" />
        <KpiCard label="Score" value="4.85 / 5" icon={CheckCircle2} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="AQAR Management Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Filing ID</th><th className="p-3">Filing Year</th><th className="p-3">Report Title</th><th className="p-3">Submission Date</th><th className="p-3">Desk Approval</th><th className="p-3">Status</th>
                </tr>
              </thead>
