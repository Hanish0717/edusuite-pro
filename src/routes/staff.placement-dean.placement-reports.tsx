...
export const Route = createFileRoute("/staff/placement-dean/placement-reports")({
  head: () => ({
    meta: [{ title: "Placement Reports — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Placement Reports</h1>
          <p className="text-sm text-muted-foreground">Master institutional placement audit report and NIRF placement metrics.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Reports Archived" value="18 Reports" icon={Building2} tone="purple" />
        <KpiCard label="NIRF Verified" value="100%" icon={Users} tone="success" />
        <KpiCard label="Audit Clearance" value="Grade A" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Placement Reports Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
