...
export const Route = createFileRoute("/staff/iqac/kpi-dashboard")({
  head: () => ({
    meta: [{ title: "KPI Dashboard — IQAC Dean" }],
  }),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Institutional KPIs" value="34 Indicators" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Target Met" value="94.2%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Academic Rank" value="#1 Institute" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="KPI Dashboard Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">KPI Code</th><th className="p-3">Indicator Description</th><th className="p-3">Target Standard</th><th className="p-3">Current Score</th><th className="p-3">Achievement %</th><th className="p-3">Status</th>
                </tr>
              </thead>
