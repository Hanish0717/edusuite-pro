...
export const Route = createFileRoute("/staff/iqac/naac-reports")({
  head: () => ({
    meta: [{ title: "NAAC Reports — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">NAAC Reports</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Reports" value="12 Reports" icon={BadgeCheck} tone="purple" />
        <KpiCard label="NAAC Grade" value="3.78 A++" icon={ShieldCheck} tone="success" />
        <KpiCard label="Audit Pass" value="100%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="NAAC Reports Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
