...
export const Route = createFileRoute("/staff/research-development/funding-agencies")({
  head: () => ({
    meta: [{ title: "Funding Agencies — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Funding Agencies</h1>
          <p className="text-sm text-muted-foreground">Empanelled funding agencies, grant call schedules, and contact details.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Agencies Mapped" value="12 Agencies" icon={FolderGit2} tone="purple" />
        <KpiCard label="Open Calls" value="4 Grants" icon={BookOpen} tone="success" />
        <KpiCard label="Contact SLA" value="Active" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Funding Agencies Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Agency Name</th><th className="p-3">Category</th><th className="p-3">Nodal Officer</th><th className="p-3">Official Portal</th><th className="p-3">Status</th>
                </tr>
              </thead>
