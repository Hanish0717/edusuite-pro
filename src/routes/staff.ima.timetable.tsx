...
export const Route = createFileRoute("/staff/ima/timetable")({
  head: () => ({
    meta: [{ title: "IMA Administration & Infra Schedule — EduSuite Pro" }],
  }),
...
function TimetableComponent() {
  ...
  const [selectedClass, setSelectedClass] = useState("Supercomputing Lab Infrastructure Review");
  ...
  const mySchedule = [
    {
      ...
      subject: "Supercomputing Lab Infrastructure Review",
      section: "Infra Committee",
      room: "IMA Office",
      time: "09:00 AM",
      status: "Scheduled"
    },
    {
      ...
      subject: "Campus Solar Grid CapEx Planning",
      section: "Energy Cell",
    ...
    },
    {
      ...
      subject: "Fire Safety & Substation Inspection",
      section: "Campus Safety",
      room: "Substation Premises",
      time: "10:00 AM",
      status: "Scheduled"
    }
  ];
  ...
  const handleAssign = () => {
    const newRecord = {
      ...
      originalFaculty: "Prof. IMA Director",
      assignedFaculty,
      reason: assignReason,
      status: "Approved",
      approvedBy: "Prof. IMA Director",
    };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">IMA Administration & Infra Schedule</h1>
      ...
      {/* TAB 1: MY TIMETABLE */}
      {activeTab === "my" && (
        <Panel title="Prof. IMA Director — Personal Teaching & Duty Schedule" description="Shows ONLY this dean's own assigned classes, meetings and office hours.">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <Select value={selectedClass} onValueChange={setSelectedClass}>
                  ...
                  <SelectContent>
                    <SelectItem value="Supercomputing Lab Infrastructure Review">Supercomputing Lab Infrastructure Review (Infra Committee)</SelectItem>
                    <SelectItem value="Campus Solar Grid CapEx Planning">Campus Solar Grid CapEx Planning (Energy Cell)</SelectItem>
                    <SelectItem value="Fire Safety & Substation Inspection">Fire Safety & Substation Inspection (Campus Safety)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
