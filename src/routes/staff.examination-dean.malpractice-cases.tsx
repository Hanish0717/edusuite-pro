...
export const Route = createFileRoute("/staff/examination-dean/malpractice-cases")({
  head: () => ({
    meta: [{ title: "Malpractice Cases — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Malpractice Cases</h1>
          <p className="text-sm text-muted-foreground">Exam hall malpractice violation reports, squad seizure ledgers, and hall tickets.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Malpractice Cases" value="2 Cases" icon={Users} tone="purple" />
        <KpiCard label="Seized Material" value="Confiscated" icon={Calendar} tone="success" />
        <KpiCard label="Committee Hearing" value="Scheduled" icon={Ticket} tone="info" />
        <KpiCard label="Status" value="Under Review" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Malpractice Cases Statistics Chart" description="Quantitative examination ledgers across academic departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Malpractice Cases Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Case Ref</th><th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Exam Hall</th><th className="p-3">Violation Description</th><th className="p-3">Seized Evidence</th><th className="p-3">Status</th>
                </tr>
              </thead>
