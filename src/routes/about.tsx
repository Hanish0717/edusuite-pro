...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "The team building AI powered ERP software for colleges." },
    ],
  }),
  component: AboutPage,
});
...
const values = [
  { title: "Built for departments", text: "Every workflow respects department scopes, so HODs stay in control of their own data." },
  { title: "Adoption first", text: "Interfaces are designed for clerks and faculty, not just administrators." },
  { title: "Compliance ready", text: "Reports are structured for NAAC, NBA and AICTE submissions out of the box." },
];

const timeline = [
  { year: "2021", text: "Started as an attendance and internals tool for a single engineering college." },
  { year: "2023", text: "Expanded into finance, hostel and transport with multi-campus support." },
  { year: "2025", text: "Launched the AI assistant and role-based dashboards across 120 campuses." },
];
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 md:px-6">
          <div className="grid gap-4 md:grid-cols-3">
            {values.map((value) => (
              <div key={value.title} className="rounded-2xl border border-border/70 bg-card p-6 shadow-card">
