...
export const Route = createFileRoute("/staff/ima/equipment-inventory")({
  head: () => ({
    meta: [{ title: "Equipment Inventory — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Master hardware inventory: brand, model, serial number, and status.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Assets" value="1,240 Assets" icon={FlaskConical} tone="purple" />
        <KpiCard label="Dell PC Count" value="450 PCs" icon={Cpu} tone="success" />
        <KpiCard label="Cisco Hardware" value="120 Units" icon={Wrench} tone="info" />
        <KpiCard label="Status" value="Working" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Equipment Inventory Distribution Chart" description="Quantitative inventory and equipment breakdown.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Equipment Inventory Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Equipment ID</th><th className="p-3">Equipment Name</th><th className="p-3">Brand & Model</th><th className="p-3">Serial Number</th><th className="p-3">Department</th><th className="p-3">Lab Room</th><th className="p-3">Purchase Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
