...
export const Route = createFileRoute("/staff/ima/amc-warranty")({
  head: () => ({
    meta: [{ title: "AMC & Warranty — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">AMC & Warranty</h1>
          <p className="text-sm text-muted-foreground">Annual Maintenance Contracts (AMC), warranty expiration, and providers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Under Warranty" value="840 Assets" icon={FlaskConical} tone="purple" />
        <KpiCard label="Under AMC" value="360 Assets" icon={Cpu} tone="success" />
        <KpiCard label="Expiring Soon" value="14 Assets" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="AMC & Warranty Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Equipment ID</th><th className="p-3">Equipment Name</th><th className="p-3">Warranty Start</th><th className="p-3">Warranty End</th><th className="p-3">AMC Provider</th><th className="p-3">Renewal Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
