...
export const Route = createFileRoute("/staff/ima/purchase-orders")({
  head: () => ({
    meta: [{ title: "Purchase Orders — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Issued purchase orders (PO), vendor details, and delivery SLAs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Active POs" value="6 Orders" icon={FlaskConical} tone="purple" />
        <KpiCard label="Total PO Value" value="₹18.2 Lacs" icon={Cpu} tone="success" />
        <KpiCard label="Delivery Pending" value="2 Orders" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Purchase Orders Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">PO Number</th><th className="p-3">Vendor Name</th><th className="p-3">Equipment Description</th><th className="p-3">Quantity</th><th className="p-3">Total Amount</th><th className="p-3">Delivery Due Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
