...
export const Route = createFileRoute("/staff/finance-dean/external-audit")({
  head: () => ({
    meta: [{ title: "External Audit — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">External Audit</h1>
          <p className="text-sm text-muted-foreground">Statutory CAG & Chartered Accountant annual audit reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Statutory Audit" value="FY 2024-25 Complete" icon={Wallet} tone="purple" />
        <KpiCard label="CAG Clearance" value="Clean Pass" icon={CreditCard} tone="success" />
        <KpiCard label="Compliance Score" value="100%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="External Audit Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Audit Ref</th><th className="p-3">Auditing Firm</th><th className="p-3">Financial Year</th><th className="p-3">Statutory Balance Sheet</th><th className="p-3">Audit Opinion</th><th className="p-3">Status</th>
                </tr>
              </thead>
