...
export const Route = createFileRoute("/staff/finance-dean/payroll-reports")({
  head: () => ({
    meta: [{ title: "Payroll Reports — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Payroll Reports</h1>
          <p className="text-sm text-muted-foreground">Faculty & staff salary disbursement ledgers, PF, and TDS tax reports.</p>
        </div>
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Payroll Reports Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Payroll Amount</th><th className="p-3">PF/TDS Compliance</th><th className="p-3">Status</th>
                </tr>
              </thead>
