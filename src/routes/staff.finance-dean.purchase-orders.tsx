...
export const Route = createFileRoute("/staff/finance-dean/purchase-orders")({
  head: () => ({
    meta: [{ title: "Purchase Orders — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Official Purchase Orders (PO) issued to authorized vendors.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="POs Issued" value="18 Orders" icon={Wallet} tone="purple" />
        <KpiCard label="Total PO Value" value="₹1.85 Cr" icon={CreditCard} tone="success" />
        <KpiCard label="Delivery Target" value="On-Time" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Purchase Orders Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">PO Number</th><th className="p-3">Vendor Name</th><th className="p-3">Equipment Scope</th><th className="p-3">Total Amount</th><th className="p-3">Issue Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
