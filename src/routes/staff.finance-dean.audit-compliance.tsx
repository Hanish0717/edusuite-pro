...
export const Route = createFileRoute("/staff/finance-dean/audit-compliance")({
  head: () => ({
    meta: [{ title: "Audit Compliance — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Compliance tracking with IT Act, GST filing, and EPFO regulations.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="GST Compliance" value="100% On-Time" icon={Wallet} tone="purple" />
        <KpiCard label="IT Returns" value="Filed" icon={CreditCard} tone="success" />
        <KpiCard label="PF Filing" value="Clear" icon={TrendingUp} tone="info" />
        <KpiCard label="Status" value="Compliant" icon={ShieldCheck} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Audit Compliance Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Regulation</th><th className="p-3">Authority</th><th className="p-3">Filing Frequency</th><th className="p-3">Last Filed Date</th><th className="p-3">Compliance Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
