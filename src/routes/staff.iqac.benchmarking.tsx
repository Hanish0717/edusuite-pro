...
export const Route = createFileRoute("/staff/iqac/benchmarking")({
  head: () => ({
    meta: [{ title: "Benchmarking — IQAC Dean" }],
  }),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="NIRF Target" value="Top 20 Rank" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Global Peer Score" value="92.4%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Benchmark Met" value="Exceeds" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Benchmarking Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Metric Area</th><th className="p-3">National Benchmark</th><th className="p-3">EduSuite Achievement</th><th className="p-3">Status</th>
                </tr>
              </thead>
