...
export const Route = createFileRoute("/staff/ima/reports")({
  head: () => ({
    meta: [{ title: "IMA Governance Reports — EduSuite Pro" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">IMA Governance Reports</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Reports" value="12 Reports" icon={Building2} tone="info" />
        <KpiCard label="Masterplan" value="2026-2030" icon={Users} tone="success" />
        <KpiCard label="Audits" value="100% Pass" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="IMA Governance Reports Ledger" description="Official domain records & ERP status.">
