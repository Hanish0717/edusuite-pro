...
export const Route = createFileRoute("/staff/research-development/timetable")({
  head: () => ({
    meta: [{ title: "R&D Research & Doctoral Schedule — EduSuite Pro" }],
  }),
...
function TimetableComponent() {
  ...
  const [selectedClass, setSelectedClass] = useState("RM801 Advanced Research Methodology");
  ...
  const mySchedule = [
    {
      ...
      subject: "RM801 Advanced Research Methodology",
      section: "PhD Scholars",
      room: "R&D Seminar Hall",
      time: "10:00 AM",
      status: "Scheduled"
    },
    {
      id: "MY-2",
      day: "Wednesday",
      period: "Period 4 (02:00 - 03:00 PM)",
      subject: "DST SERB Sponsored Grant Review",
    ...
    },
    {
      ...
      subject: "Patent & IPR Filing Scrutiny",
      section: "Faculty Inventors",
      room: "IPR Cell",
      time: "09:00 AM",
      status: "Scheduled"
    }
  ...
  const handleAssign = () => {
    const newRecord = {
      ...
      originalFaculty: "Prof. Research Dean",
      assignedFaculty,
      reason: assignReason,
      status: "Approved",
      approvedBy: "Prof. Research Dean",
    };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">R&D Research & Doctoral Schedule</h1>
      ...
      {/* TAB 1: MY TIMETABLE */}
      {activeTab === "my" && (
        <Panel title="Prof. Research Dean — Personal Teaching & Duty Schedule" description="Shows ONLY this dean's own assigned classes, meetings and office hours.">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <Select value={selectedClass} onValueChange={setSelectedClass}>
                  ...
                  <SelectContent>
                    <SelectItem value="RM801 Advanced Research Methodology">RM801 Advanced Research Methodology (PhD Scholars)</SelectItem>
                    <SelectItem value="DST SERB Sponsored Grant Review">DST SERB Sponsored Grant Review (Principal Investigators)</SelectItem>
                    <SelectItem value="Patent & IPR Filing Scrutiny">Patent & IPR Filing Scrutiny (Faculty Inventors)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
