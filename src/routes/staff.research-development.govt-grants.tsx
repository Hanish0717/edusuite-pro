...
export const Route = createFileRoute("/staff/research-development/govt-grants")({
  head: () => ({
    meta: [{ title: "Government Grants — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Government Grants</h1>
          <p className="text-sm text-muted-foreground">Central & State government research grants (DST, SERB, DRDO, ISRO, AICTE).</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Govt Grants" value="14 Grants" icon={FolderGit2} tone="purple" />
        <KpiCard label="Total Fund" value="₹7.20 Cr" icon={BookOpen} tone="success" />
        <KpiCard label="Agencies" value="DST, SERB, DRDO" icon={Award} tone="info" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Government Grants Breakdown Chart" description="Quantitative research metrics across departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Government Grants Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Grant Code</th><th className="p-3">Funding Agency</th><th className="p-3">Scheme Name</th><th className="p-3">Sanctioned Amount</th><th className="p-3">PI Name</th><th className="p-3">Department</th><th className="p-3">Status</th>
                </tr>
              </thead>
