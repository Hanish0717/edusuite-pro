...
export const Route = createFileRoute("/staff/iqac/compliance-tracker")({
  head: () => ({
    meta: [{ title: "Compliance Tracker — IQAC Dean" }],
  }),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Compliance Rate" value="100%" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Mandatory Items" value="24 Items" icon={ShieldCheck} tone="success" />
        <KpiCard label="Due Dates SLA" value="On Track" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Compliance Tracker Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Item Code</th><th className="p-3">Compliance Title</th><th className="p-3">Authority</th><th className="p-3">Due Date</th><th className="p-3">Responsible Officer</th><th className="p-3">Status</th>
                </tr>
              </thead>
