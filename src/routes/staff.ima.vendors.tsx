...
export const Route = createFileRoute("/staff/ima/vendors")({
  head: () => ({
    meta: [{ title: "Vendors — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Authorized equipment manufacturers, AMC providers, and contact details.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Active Vendors" value="12 Partners" icon={FlaskConical} tone="purple" />
        <KpiCard label="Tier-1 Brands" value="Dell, HP, Cisco" icon={Cpu} tone="success" />
        <KpiCard label="Rating Avg" value="4.85 / 5" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Vendors Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Vendor ID</th><th className="p-3">Vendor Name</th><th className="p-3">Brand / Category</th><th className="p-3">Contract Scope</th><th className="p-3">Contact Person</th><th className="p-3">Phone / Email</th><th className="p-3">Status</th>
                </tr>
              </thead>
