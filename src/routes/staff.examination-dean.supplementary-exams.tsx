...
export const Route = createFileRoute("/staff/examination-dean/supplementary-exams")({
  head: () => ({
    meta: [{ title: "Supplementary Exams — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Supplementary Exams</h1>
          <p className="text-sm text-muted-foreground">Arrear & supplementary exam registrations, fee payment, and schedules.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Arrear Registrations" value="340 Students" icon={Users} tone="purple" />
        <KpiCard label="Fee Collected" value="₹5.10 Lacs" icon={Calendar} tone="success" />
        <KpiCard label="Schedules Dispatched" value="100%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Supplementary Exams Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Arrear Subject Code</th><th className="p-3">Subject Title</th><th className="p-3">Exam Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
