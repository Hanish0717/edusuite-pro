...
export const Route = createFileRoute("/staff/iqac/meetings")({
  head: () => ({
    meta: [{ title: "IQAC Meetings — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">IQAC Meetings</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Meetings Conducted" value="4 Meetings / Yr" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Attendance Rate" value="98.0%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Minutes Signed" value="100%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="IQAC Meetings Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Meeting Ref</th><th className="p-3">Meeting Title</th><th className="p-3">Date</th><th className="p-3">Venue</th><th className="p-3">MoM Document</th><th className="p-3">Status</th>
                </tr>
              </thead>
