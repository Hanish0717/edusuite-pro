...
export const Route = createFileRoute("/staff/ima/purchase-reports")({
  head: () => ({
    meta: [{ title: "Purchase Reports — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Purchase Reports</h1>
          <p className="text-sm text-muted-foreground">Capital procurement reports, PO ledgers, and vendor performance.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="POs Issued" value="14 Orders" icon={FlaskConical} tone="purple" />
        <KpiCard label="Capital Spent" value="₹42.8 Lacs" icon={Cpu} tone="success" />
        <KpiCard label="Delivery SLA" value="100%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Purchase Reports Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Total PO Value</th><th className="p-3">Vendor Performance</th><th className="p-3">Status</th>
                </tr>
              </thead>
