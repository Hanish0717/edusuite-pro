...
export const Route = createFileRoute("/staff/placement-dean/internship-reports")({
  head: () => ({
    meta: [{ title: "Internship Reports — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Internship Reports</h1>
          <p className="text-sm text-muted-foreground">Internship completion certificates, PPO conversion rates, and stipend audit.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Completed Internships" value="420 Students" icon={Building2} tone="purple" />
        <KpiCard label="PPOs Converted" value="273 PPO Offers (65%)" icon={Users} tone="success" />
        <KpiCard label="Audit Clearance" value="Verified" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Internship Reports Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Scope</th><th className="p-3">PPO Conversion Rate</th><th className="p-3">Status</th>
                </tr>
              </thead>
