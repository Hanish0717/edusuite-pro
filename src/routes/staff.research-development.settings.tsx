...
export const Route = createFileRoute("/staff/research-development/settings")({
  head: () => ({
    meta: [{ title: "R&D Portal Settings — EduSuite Pro" }],
  }),
...
function SubPageComponent() {
  ...
  const rawItems = useMemo(() => {
    return [ { name: 'SCI Journal Publication Incentive', val: '₹50,000 / Paper', date: '2026-01-01', status: 'Active' } ];
  }, [data]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">R&D Portal Settings</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="R&D Dean" value="Prof. Research Dean" icon={Building2} tone="info" />
        <KpiCard label="SCI Paper Bonus" value="₹50,000 / Paper" icon={Users} tone="success" />
      ...
      <Panel title="R&D Portal Settings Ledger" description="Official domain records & ERP status.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Policy Setting</th><th className="p-3">Reward / Value</th><th className="p-3">Effective Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
