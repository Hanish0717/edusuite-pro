...
export const Route = createFileRoute("/staff/placement-dean/company-reports")({
  head: () => ({
    meta: [{ title: "Company Reports — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Company Reports</h1>
          <p className="text-sm text-muted-foreground">Recruiter feedback reports, HR satisfaction index, and salary trend analysis.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Recruiters Audited" value="142 Companies" icon={Building2} tone="purple" />
        <KpiCard label="HR Rating" value="4.8 / 5.0" icon={Users} tone="success" />
        <KpiCard label="Repeat Hiring" value="94.0%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Company Reports Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Companies Audited</th><th className="p-3">Satisfaction Score</th><th className="p-3">Status</th>
                </tr>
              </thead>
