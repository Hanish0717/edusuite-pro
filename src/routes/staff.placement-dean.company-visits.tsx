...
export const Route = createFileRoute("/staff/placement-dean/company-visits")({
  head: () => ({
    meta: [{ title: "Company Visits — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Company Visits</h1>
          <p className="text-sm text-muted-foreground">Scheduled corporate campus visits, HR executive hospitality, and auditorium slots.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Campus Visits" value="64 Visits" icon={Building2} tone="purple" />
        <KpiCard label="Auditorium Booked" value="100%" icon={Users} tone="success" />
        <KpiCard label="HR Guests" value="180 Executives" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Company Visits Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Visit Date</th><th className="p-3">Auditorium Venue</th><th className="p-3">HR Lead</th><th className="p-3">Drive Type</th><th className="p-3">Status</th>
                </tr>
              </thead>
