...
export const Route = createFileRoute("/staff/research-development/sponsored-projects")({
  head: () => ({
    meta: [{ title: "Sponsored Projects — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Sponsored Projects</h1>
          <p className="text-sm text-muted-foreground">External government & international sponsored research projects.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Sponsored Grants" value="18 Grants" icon={FolderGit2} tone="purple" />
        <KpiCard label="DST / SERB" value="12 Projects" icon={BookOpen} tone="success" />
        <KpiCard label="DRDO / ISRO" value="6 Projects" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Sponsored Projects Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Project ID</th><th className="p-3">Project Title</th><th className="p-3">Sponsoring Agency</th><th className="p-3">PI Name</th><th className="p-3">Sanctioned Amount</th><th className="p-3">Status</th>
                </tr>
              </thead>
