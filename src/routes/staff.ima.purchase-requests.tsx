...
export const Route = createFileRoute("/staff/ima/purchase-requests")({
  head: () => ({
    meta: [{ title: "Purchase Requests — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Requisition requests for new hardware, lab equipment, and consumables.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Requisitions" value="8 Requests" icon={FlaskConical} tone="purple" />
        <KpiCard label="Est Total" value="₹24.5 Lacs" icon={Cpu} tone="success" />
        <KpiCard label="Under Scrutiny" value="2 Requests" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Purchase Requests Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Req Ref</th><th className="p-3">Requested By</th><th className="p-3">Department</th><th className="p-3">Equipment Item</th><th className="p-3">Qty</th><th className="p-3">Est Cost</th><th className="p-3">Status</th>
                </tr>
              </thead>
