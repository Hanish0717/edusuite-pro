...
export const Route = createFileRoute("/staff/finance-dean/scholarships-concessions")({
  head: () => ({
    meta: [{ title: "Scholarships & Fee Concessions — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Scholarships & Fee Concessions</h1>
          <p className="text-sm text-muted-foreground">Govt Jagananna / Epass scholarship adjustments & merit fee waivers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Scholarships Disbursed" value="₹3.80 Cr" icon={Wallet} tone="purple" />
        <KpiCard label="Beneficiaries" value="1,240 Students" icon={CreditCard} tone="success" />
        <KpiCard label="Govt Reimbursed" value="100%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Scholarships & Fee Concessions Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Scholarship ID</th><th className="p-3">Student Name</th><th className="p-3">Scheme Name</th><th className="p-3">Category</th><th className="p-3">Concession Amount</th><th className="p-3">Status</th>
                </tr>
              </thead>
