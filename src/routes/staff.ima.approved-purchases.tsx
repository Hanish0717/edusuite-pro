...
export const Route = createFileRoute("/staff/ima/approved-purchases")({
  head: () => ({
    meta: [{ title: "Approved Purchases — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Approved Purchases</h1>
          <p className="text-sm text-muted-foreground">Procurement ledger of approved lab hardware purchases.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Approved POs" value="14 Orders" icon={FlaskConical} tone="purple" />
        <KpiCard label="Cleared Amount" value="₹42.8 Lacs" icon={Cpu} tone="success" />
        <KpiCard label="Asset Tagged" value="100%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Approved Purchases Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">PO Number</th><th className="p-3">Equipment Item</th><th className="p-3">Vendor</th><th className="p-3">Final Amount</th><th className="p-3">Approval Date</th><th className="p-3">Asset Tagging</th><th className="p-3">Status</th>
                </tr>
              </thead>
