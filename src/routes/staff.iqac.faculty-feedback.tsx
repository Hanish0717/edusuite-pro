...
export const Route = createFileRoute("/staff/iqac/faculty-feedback")({
  head: () => ({
    meta: [{ title: "Faculty Feedback — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Faculty Feedback</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Faculty Rate" value="98.0%" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Avg Score" value="4.82 / 5" icon={ShieldCheck} tone="success" />
        <KpiCard label="Total Roster" value="245 Faculty" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Faculty Feedback Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Department</th><th className="p-3">Faculty Count</th><th className="p-3">Survey Response</th><th className="p-3">Facility Score</th><th className="p-3">Status</th>
                </tr>
              </thead>
