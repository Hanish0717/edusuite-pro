...
export const Route = createFileRoute("/staff/finance-dean/dept-budgets")({
  head: () => ({
    meta: [{ title: "Department Budgets — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Department Budgets</h1>
          <p className="text-sm text-muted-foreground">Department-wise budget breakdown, lab allocation, and HOD approval ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Depts Mapped" value="8 Departments" icon={Wallet} tone="purple" />
        <KpiCard label="Total Allocated" value="₹36.8 Cr" icon={CreditCard} tone="success" />
        <KpiCard label="HOD Approval" value="100%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Department Budgets Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Dept Code</th><th className="p-3">Department Name</th><th className="p-3">Allocated Budget</th><th className="p-3">Lab Budget</th><th className="p-3">Research Budget</th><th className="p-3">Utilization %</th><th className="p-3">Status</th>
                </tr>
              </thead>
