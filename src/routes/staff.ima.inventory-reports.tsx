...
export const Route = createFileRoute("/staff/ima/inventory-reports")({
  head: () => ({
    meta: [{ title: "Inventory Reports — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Department-wise inventory audit logs and stock registers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Stock Ledger" value="₹4.82 Cr" icon={FlaskConical} tone="purple" />
        <KpiCard label="Depts Mapped" value="5 Departments" icon={Cpu} tone="success" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Inventory Reports Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Department Scope</th><th className="p-3">Valuation</th><th className="p-3">Status</th>
                </tr>
              </thead>
