...
export const Route = createFileRoute("/staff/finance-dean/settings")({
  head: () => ({
    meta: [{ title: "Finance Dean Portal Settings — EduSuite Pro" }],
  }),
...
function SubPageComponent() {
  ...
  const rawItems = useMemo(() => {
    return [ { name: 'Financial Approval Limit', val: '₹10,00,000 / Voucher', date: '2026-01-10', status: 'Active' } ];
  }, [data]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Finance Dean Portal Settings</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Finance Dean" value="Prof. Finance Dean" icon={Building2} tone="info" />
        <KpiCard label="Approval Threshold" value="₹10.0 Lakhs" icon={Users} tone="success" />
      ...
      <Panel title="Finance Dean Portal Settings Ledger" description="Official domain records & ERP status.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Parameter Name</th><th className="p-3">Configured Value</th><th className="p-3">Last Modified</th><th className="p-3">Status</th>
                </tr>
              </thead>
