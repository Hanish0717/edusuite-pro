...
export const Route = createFileRoute("/staff/examination-dean/committee-reports")({
  head: () => ({
    meta: [{ title: "Committee Reports — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Committee Reports</h1>
          <p className="text-sm text-muted-foreground">Malpractice Standing Committee inquiry reports and hearing minutes.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Committee Hearings" value="2 Hearings" icon={Users} tone="purple" />
        <KpiCard label="Findings" value="Documented" icon={Calendar} tone="success" />
        <KpiCard label="Dean Sanction" value="Approved" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Committee Reports Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Case Ref</th><th className="p-3">Student Name</th><th className="p-3">Committee Chair</th><th className="p-3">Hearing Date</th><th className="p-3">Committee Recommendation</th><th className="p-3">Status</th>
                </tr>
              </thead>
