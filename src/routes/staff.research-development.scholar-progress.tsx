...
export const Route = createFileRoute("/staff/research-development/scholar-progress")({
  head: () => ({
    meta: [{ title: "Scholar Progress — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Scholar Progress</h1>
          <p className="text-sm text-muted-foreground">Doctoral Committee (DC) review progress, seminars, and thesis status.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="DC Reviews Mtd" value="145 Reviews" icon={FolderGit2} tone="purple" />
        <KpiCard label="Seminars Given" value="92 Seminars" icon={BookOpen} tone="success" />
        <KpiCard label="Thesis Submitted" value="12 Scholars" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Scholar Progress Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Scholar Name</th><th className="p-3">Guide Name</th><th className="p-3">DC Review #</th><th className="p-3">Progress %</th><th className="p-3">Expected Completion</th><th className="p-3">Status</th>
                </tr>
              </thead>
