...
export const Route = createFileRoute("/staff/placement-dean/eligible-students")({
  head: () => ({
    meta: [{ title: "Eligible Students — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Eligible Students</h1>
          <p className="text-sm text-muted-foreground">Placement eligible student directory, backlogs clearance, and CGPA audit.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Eligible Students" value="1,850 Students" icon={Building2} tone="purple" />
        <KpiCard label="Eligibility Rate" value="94.2%" icon={Users} tone="success" />
        <KpiCard label="No Active Backlogs" value="1,850 Students" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Eligible" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Eligible Students Distribution Chart" description="Quantitative placement metrics across academic departments and recruiters.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Eligible Students Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Department</th><th className="p-3">CGPA</th><th className="p-3">Active Backlogs</th><th className="p-3">Eligibility Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
