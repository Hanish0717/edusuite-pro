...
export const Route = createFileRoute("/staff/finance-dean/vendor-management")({
  head: () => ({
    meta: [{ title: "Vendor Management — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Empanelled vendor list, GST details, bank accounts, and ratings.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Empanelled Vendors" value="24 Vendors" icon={Wallet} tone="purple" />
        <KpiCard label="Tier-1 Vendors" value="Dell, HP, Cisco" icon={CreditCard} tone="success" />
        <KpiCard label="GST Compliant" value="100%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Vendor Management Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Vendor Code</th><th className="p-3">Vendor Name</th><th className="p-3">GST Number</th><th className="p-3">Supply Domain</th><th className="p-3">Bank Account / IFSC</th><th className="p-3">Status</th>
                </tr>
              </thead>
