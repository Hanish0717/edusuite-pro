...
export const Route = createFileRoute("/staff/ima/equipment-allocation")({
  head: () => ({
    meta: [{ title: "Equipment Allocation — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Equipment Allocation</h1>
          <p className="text-sm text-muted-foreground">Asset assignment to laboratories, departments, and faculty incharge.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Allocated" value="1,180 Assets" icon={FlaskConical} tone="purple" />
        <KpiCard label="Unallocated" value="60 Spares" icon={Cpu} tone="success" />
        <KpiCard label="Utilization" value="95.1%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Equipment Allocation Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Asset Tag</th><th className="p-3">Equipment Name</th><th className="p-3">Allocated Department</th><th className="p-3">Assigned Laboratory</th><th className="p-3">Faculty Incharge</th><th className="p-3">Allocation Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
