...
export const Route = createFileRoute("/staff/finance-dean/salary-history")({
  head: () => ({
    meta: [{ title: "Salary History — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Salary History</h1>
          <p className="text-sm text-muted-foreground">Historical monthly payroll ledgers, Form 16, and annual salary statements.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard label="Form 16 Issued" value="100%" icon={CreditCard} tone="success" />
        <KpiCard label="Audit Verification" value="Clear" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Salary History Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Financial Year</th><th className="p-3">Month</th><th className="p-3">Total Salary Disbursed</th><th className="p-3">PF Deposited</th><th className="p-3">TDS Remitted</th><th className="p-3">Status</th>
                </tr>
              </thead>
