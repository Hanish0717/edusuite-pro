...
export const Route = createFileRoute("/staff/placement-dean/recruitment-partners")({
  head: () => ({
    meta: [{ title: "Recruitment Partners — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Recruitment Partners</h1>
          <p className="text-sm text-muted-foreground">Long-term corporate campus hiring partners and Industry Advisory Board ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Partners" value="48 Companies" icon={Building2} tone="purple" />
        <KpiCard label="Annual Repeat Rate" value="94.0%" icon={Users} tone="success" />
        <KpiCard label="MoU Validity" value="3 Years Avg" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Recruitment Partners Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Partner Name</th><th className="p-3">Tier Level</th><th className="p-3">Partnership Since</th><th className="p-3">Annual Hires Avg</th><th className="p-3">MoU Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
