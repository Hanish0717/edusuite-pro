...
export const Route = createFileRoute("/staff/iqac/quality-improvement")({
  head: () => ({
    meta: [{ title: "Quality Improvement Plans — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Quality Improvement Plans</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Active QIPs" value="8 Plans" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Implemented" value="6 Plans" icon={ShieldCheck} tone="success" />
        <KpiCard label="Under Review" value="2 Plans" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Quality Improvement Plans Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Plan ID</th><th className="p-3">Improvement Initiative</th><th className="p-3">Target Dept</th><th className="p-3">Target Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
