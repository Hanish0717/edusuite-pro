...
export const Route = createFileRoute("/staff/iqac/nba")({
  head: () => ({
    meta: [{ title: "NBA Accreditation — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">NBA Accreditation</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Accredited Depts" value="12 / 15" icon={BadgeCheck} tone="purple" />
        <KpiCard label="SAR Dossiers" value="Submitted" icon={ShieldCheck} tone="success" />
        <KpiCard label="OBE Attainment" value="94.2%" icon={FileText} tone="info" />
        <KpiCard label="Tier" value="Tier-1" icon={CheckCircle2} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="NBA Accreditation Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Dept Code</th><th className="p-3">Department Name</th><th className="p-3">SAR Filing Date</th><th className="p-3">Validity Period</th><th className="p-3">Accreditation Tier</th><th className="p-3">Status</th>
                </tr>
              </thead>
