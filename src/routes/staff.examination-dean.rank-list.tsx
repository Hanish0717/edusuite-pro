...
export const Route = createFileRoute("/staff/examination-dean/rank-list")({
  head: () => ({
    meta: [{ title: "Rank List — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Rank List</h1>
          <p className="text-sm text-muted-foreground">Department gold medalist & top academic rank holders list.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Rank 1 Gold Medalist" value="CGPA 9.85" icon={Users} tone="purple" />
        <KpiCard label="Top 10 Ranks" value="Published" icon={Calendar} tone="success" />
        <KpiCard label="Medals Sanctioned" value="Gold & Silver" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Rank List Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Rank #</th><th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Department</th><th className="p-3">CGPA</th><th className="p-3">Academic Distinction</th><th className="p-3">Status</th>
                </tr>
              </thead>
