...
export const Route = createFileRoute("/staff/examination-dean/hall-ticket-reports")({
  head: () => ({
    meta: [{ title: "Hall Ticket Reports — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Hall Ticket Reports</h1>
          <p className="text-sm text-muted-foreground">Hall ticket issuance audit, attendance shortage withheld list, and download logs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Tickets Issued" value="4,850 Tickets" icon={Users} tone="purple" />
        <KpiCard label="Withheld List" value="120 Students" icon={Calendar} tone="success" />
        <KpiCard label="Audit Pass" value="100%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Hall Ticket Reports Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Issued Count</th><th className="p-3">Withheld Count</th><th className="p-3">Status</th>
                </tr>
              </thead>
