...
export const Route = createFileRoute("/staff/placement-dean/off-campus-drives")({
  head: () => ({
    meta: [{ title: "Off-Campus Drives — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Off-Campus Drives</h1>
          <p className="text-sm text-muted-foreground">Pool campus & off-campus hiring opportunities, referral drives, and external venues.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Off-Campus Drives" value="12 Drives" icon={Building2} tone="purple" />
        <KpiCard label="Referral Offers" value="85 Offers" icon={Users} tone="success" />
        <KpiCard label="Venue Verification" value="Passed" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Off-Campus Drives Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Off-Campus Venue</th><th className="p-3">Drive Date</th><th className="p-3">Eligible Batch</th><th className="p-3">Registered Students</th><th className="p-3">Status</th>
                </tr>
              </thead>
