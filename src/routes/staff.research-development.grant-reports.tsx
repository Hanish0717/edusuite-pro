...
export const Route = createFileRoute("/staff/research-development/grant-reports")({
  head: () => ({
    meta: [{ title: "Grant Reports — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Grant Reports</h1>
          <p className="text-sm text-muted-foreground">Sponsored research grants audit reports and utilization ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Grant Funds" value="₹8.45 Cr" icon={FolderGit2} tone="purple" />
        <KpiCard label="UC Clearance" value="100%" icon={BookOpen} tone="success" />
        <KpiCard label="Sanction Pass" value="Verified" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Grant Reports Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Grant Total</th><th className="p-3">Utilization %</th><th className="p-3">Status</th>
                </tr>
              </thead>
