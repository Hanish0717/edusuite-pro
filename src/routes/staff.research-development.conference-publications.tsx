...
export const Route = createFileRoute("/staff/research-development/conference-publications")({
  head: () => ({
    meta: [{ title: "Conference Publications — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Conference Publications</h1>
          <p className="text-sm text-muted-foreground">IEEE, ACM, & Springer international conference proceedings.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Conferences" value="180 Papers" icon={FolderGit2} tone="purple" />
        <KpiCard label="IEEE / ACM" value="120 Papers" icon={BookOpen} tone="success" />
        <KpiCard label="Citations" value="1,240 Count" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Conference Publications Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Paper Title</th><th className="p-3">Authors</th><th className="p-3">Conference Name</th><th className="p-3">Organizer</th><th className="p-3">Indexing</th><th className="p-3">Year</th><th className="p-3">Status</th>
                </tr>
              </thead>
