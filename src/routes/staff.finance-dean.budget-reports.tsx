...
export const Route = createFileRoute("/staff/finance-dean/budget-reports")({
  head: () => ({
    meta: [{ title: "Budget Reports — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Budget Reports</h1>
          <p className="text-sm text-muted-foreground">Department budget utilization and variance analysis reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Budget" value="₹48.5 Cr" icon={Wallet} tone="purple" />
        <KpiCard label="Variance Score" value="95.2%" icon={CreditCard} tone="success" />
        <KpiCard label="SLA Clearance" value="Verified" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Budget Reports Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Sanctioned Budget</th><th className="p-3">Utilization Rate</th><th className="p-3">Status</th>
                </tr>
              </thead>
