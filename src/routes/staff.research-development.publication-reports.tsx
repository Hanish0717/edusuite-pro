...
export const Route = createFileRoute("/staff/research-development/publication-reports")({
  head: () => ({
    meta: [{ title: "Publication Reports — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Publication Reports</h1>
          <p className="text-sm text-muted-foreground">SCI & Scopus publication compilations, impact factors & citations.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Publications" value="522 Papers" icon={FolderGit2} tone="purple" />
        <KpiCard label="Citations" value="4,850 Count" icon={BookOpen} tone="success" />
        <KpiCard label="h-Index" value="18.4" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Publication Reports Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Paper Count</th><th className="p-3">SCI Ratio</th><th className="p-3">Status</th>
                </tr>
              </thead>
