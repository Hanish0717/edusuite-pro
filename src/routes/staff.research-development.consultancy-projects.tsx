...
export const Route = createFileRoute("/staff/research-development/consultancy-projects")({
  head: () => ({
    meta: [{ title: "Consultancy Projects — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Industry consultancy projects and institutional revenue.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Consultancy Reqs" value="10 Projects" icon={FolderGit2} tone="purple" />
        <KpiCard label="Revenue Earned" value="₹85.0 Lacs" icon={BookOpen} tone="success" />
        <KpiCard label="Corporate Clients" value="8 Companies" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Consultancy Projects Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Project Ref</th><th className="p-3">Client Organization</th><th className="p-3">Project Scope</th><th className="p-3">Faculty Consultant</th><th className="p-3">Consultancy Fee</th><th className="p-3">Status</th>
                </tr>
              </thead>
