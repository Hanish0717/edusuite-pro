...
export const Route = createFileRoute("/staff/ima/maintenance-requests")({
  head: () => ({
    meta: [{ title: "Maintenance Requests — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Hardware failure reports, repair tickets, and assigned engineers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Open Tickets" value="12 Tickets" icon={FlaskConical} tone="purple" />
        <KpiCard label="Resolved / Mtd" value="84 Tickets" icon={Cpu} tone="success" />
        <KpiCard label="Avg SLA" value="24 Hours" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Maintenance Requests Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Ticket ID</th><th className="p-3">Equipment Name</th><th className="p-3">Issue Description</th><th className="p-3">Department / Lab</th><th className="p-3">Assigned Tech</th><th className="p-3">Priority</th><th className="p-3">Status</th>
                </tr>
              </thead>
