...
export const Route = createFileRoute("/staff/academic-dean/attendance-reports")({
  head: () => ({
    meta: [{ title: "Attendance Reports — Academic Dean" }],
  }),
...
function SubPageComponent() {
  ...
  const headers = ["Report Title","Average Attendance","Shortage %","Status"];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Institutional student attendance tracking, condonation list, and shortage report.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard label="Shortage List" value="510 Students" icon={Users} tone="success" onClick={() => { setFilter("active"); toast.info("Filtering active records"); }} className="cursor-pointer hover:border-primary/50 transition-all" />
        <KpiCard label="Shortage %" value="8.7%" icon={BookOpen} tone="info" onClick={() => { setFilter("completed"); toast.info("Filtering completed records"); }} className="cursor-pointer hover:border-primary/50 transition-all" />
