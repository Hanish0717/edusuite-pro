...
export const Route = createFileRoute("/staff/placement-dean/upcoming-drives")({
  head: () => ({
    meta: [{ title: "Upcoming Drives — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Upcoming Drives</h1>
          <p className="text-sm text-muted-foreground">Scheduled campus recruitment drives, registration deadlines, and eligibility criteria.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Upcoming Drives" value="18 Drives" icon={Building2} tone="purple" />
        <KpiCard label="Registered Students" value="1,420 Registrations" icon={Users} tone="success" />
        <KpiCard label="Venue Ready" value="Verified" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Scheduled" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Upcoming Drives Distribution Chart" description="Quantitative placement metrics across academic departments and recruiters.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Upcoming Drives Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company</th><th className="p-3">Drive Date</th><th className="p-3">Venue</th><th className="p-3">Eligible Branches</th><th className="p-3">Eligible CGPA</th><th className="p-3">Rounds</th><th className="p-3">Status</th>
                </tr>
              </thead>
