...
export const Route = createFileRoute("/staff/iqac/quality-metrics")({
  head: () => ({
    meta: [{ title: "Quality Metrics — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Quality Metrics</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Overall Score" value="94.8 / 100" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Teaching Index" value="96.2%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Research Index" value="93.4%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Quality Metrics Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Metric Name</th><th className="p-3">Standard Norm</th><th className="p-3">Current Achievement</th><th className="p-3">Status</th>
                </tr>
              </thead>
