...
export const Route = createFileRoute("/staff/finance-dean/financial-reports")({
  head: () => ({
    meta: [{ title: "Financial Reports — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Master financial balance sheet, profit & loss, and liquidity reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Reports Archived" value="24 Reports" icon={Wallet} tone="purple" />
        <KpiCard label="Audit Clearance" value="100%" icon={CreditCard} tone="success" />
        <KpiCard label="Financial Health" value="Optimal" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Financial Reports Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Financial Scope</th><th className="p-3">Generated Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
