...
export const Route = createFileRoute("/staff/iqac/atr")({
  head: () => ({
    meta: [{ title: "Action Taken Reports (ATR) — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Action Taken Reports (ATR)</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total ATR Items" value="28 Resolutions" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Completed Action" value="26 Implemented" icon={ShieldCheck} tone="success" />
        <KpiCard label="Pending" value="2 In Progress" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Action Taken Reports (ATR) Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Resolution Ref</th><th className="p-3">Resolution Item</th><th className="p-3">Responsible Officer</th><th className="p-3">Action Taken</th><th className="p-3">Status</th>
                </tr>
              </thead>
