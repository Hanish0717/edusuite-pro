...
export const Route = createFileRoute("/staff/finance-dean/purchase-payments")({
  head: () => ({
    meta: [{ title: "Purchase Payments — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Purchase Payments</h1>
          <p className="text-sm text-muted-foreground">Payments for capital equipment POs, GPU servers, and software licenses.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Purchase Payments" value="₹4.20 Cr" icon={Wallet} tone="purple" />
        <KpiCard label="PO Ledgers Cleared" value="100%" icon={CreditCard} tone="success" />
        <KpiCard label="Vendor SLA" value="On-Time" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Purchase Payments Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Payment ID</th><th className="p-3">PO Number</th><th className="p-3">Vendor / Manufacturer</th><th className="p-3">Item Description</th><th className="p-3">Amount Paid</th><th className="p-3">Status</th>
                </tr>
              </thead>
