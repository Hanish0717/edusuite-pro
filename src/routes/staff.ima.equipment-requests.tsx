...
export const Route = createFileRoute("/staff/ima/equipment-requests")({
  head: () => ({
    meta: [{ title: "Equipment Requests — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Equipment Requests</h1>
          <p className="text-sm text-muted-foreground">Faculty requests for new lab hardware, Oscilloscopes, and PCs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Pending Reqs" value="6 Requests" icon={FlaskConical} tone="purple" />
        <KpiCard label="Approved" value="14 Orders" icon={Cpu} tone="success" />
        <KpiCard label="Est Cost" value="₹18.4 Lacs" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Equipment Requests Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Req ID</th><th className="p-3">Requested By</th><th className="p-3">Department</th><th className="p-3">Equipment Required</th><th className="p-3">Quantity</th><th className="p-3">Estimated Cost</th><th className="p-3">Approval Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
