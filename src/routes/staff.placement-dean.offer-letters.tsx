...
export const Route = createFileRoute("/staff/placement-dean/offer-letters")({
  head: () => ({
    meta: [{ title: "Offer Letters — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Offer Letters</h1>
          <p className="text-sm text-muted-foreground">Official corporate offer letters, join date acceptance, and NOC issuance.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Offer Letters Issued" value="1,640 Offers" icon={Building2} tone="purple" />
        <KpiCard label="Acceptance Rate" value="97.5%" icon={Users} tone="success" />
        <KpiCard label="Joining Dates Set" value="Verified" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Released" icon={Award} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Offer Letters Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Company Name</th><th className="p-3">Offer Date</th><th className="p-3">Joining Date</th><th className="p-3">Offer Letter Doc</th><th className="p-3">Status</th>
                </tr>
              </thead>
