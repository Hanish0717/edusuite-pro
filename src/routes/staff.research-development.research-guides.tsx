...
export const Route = createFileRoute("/staff/research-development/research-guides")({
  head: () => ({
    meta: [{ title: "Research Guides — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Research Guides</h1>
          <p className="text-sm text-muted-foreground">Approved PhD supervisor list, vacancy slots, and scholar quotas.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Approved Guides" value="48 Guides" icon={FolderGit2} tone="purple" />
        <KpiCard label="Total Quota" value="280 Slots" icon={BookOpen} tone="success" />
        <KpiCard label="Vacancy" value="135 Slots" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Research Guides Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Guide Name</th><th className="p-3">Department</th><th className="p-3">Designation</th><th className="p-3">Scholars Guided</th><th className="p-3">Available Slots</th><th className="p-3">Status</th>
                </tr>
              </thead>
