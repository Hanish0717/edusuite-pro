...
export const Route = createFileRoute("/staff/iqac/employer-feedback")({
  head: () => ({
    meta: [{ title: "Employer Feedback — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Employer Feedback</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Employer Score" value="4.72 / 5" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Recruiters" value="78 Companies" icon={ShieldCheck} tone="success" />
        <KpiCard label="Skill Rating" value="92.0%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Employer Feedback Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Recruiter Company</th><th className="p-3">Tier</th><th className="p-3">Hired Graduates</th><th className="p-3">Skill Rating</th><th className="p-3">Status</th>
                </tr>
              </thead>
