...
export const Route = createFileRoute("/staff/finance-dean/reports")({
  head: () => ({
    meta: [{ title: "Financial Reports & Balance Sheets — EduSuite Pro" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Financial Reports & Balance Sheets</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Reports" value="14 Balance Sheets" icon={Building2} tone="info" />
        <KpiCard label="Statutory Audit" value="Clean Pass" icon={Users} tone="success" />
        <KpiCard label="Budget Utilization" value="88.4%" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="Financial Reports & Balance Sheets Ledger" description="Official domain records & ERP status.">
