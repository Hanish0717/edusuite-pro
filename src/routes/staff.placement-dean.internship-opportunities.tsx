...
export const Route = createFileRoute("/staff/placement-dean/internship-opportunities")({
  head: () => ({
    meta: [{ title: "Internship Opportunities — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Internship Opportunities</h1>
          <p className="text-sm text-muted-foreground">Summer internship postings, PPO pathways, and corporate stipend packages.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Opportunities" value="85 Postings" icon={Building2} tone="purple" />
        <KpiCard label="Stipend Range" value="₹25k - ₹1.2L / Mo" icon={Users} tone="success" />
        <KpiCard label="PPO Offered" value="65%" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Active" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Internship Opportunities Distribution Chart" description="Quantitative placement metrics across academic departments and recruiters.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Internship Opportunities Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Role / Domain</th><th className="p-3">Duration</th><th className="p-3">Stipend / Month</th><th className="p-3">Department Scope</th><th className="p-3">Students Selected</th><th className="p-3">Status</th>
                </tr>
              </thead>
