...
export const Route = createFileRoute("/staff/iqac/dept-quality-metrics")({
  head: () => ({
    meta: [{ title: "Department Quality Metrics — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Department Quality Metrics</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Dept Rank #1" value="CSE Dept" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Quality Index" value="94.8%" icon={ShieldCheck} tone="success" />
        <KpiCard label="OBE Attainment" value="95.2%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Department Quality Metrics Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Rank</th><th className="p-3">Department Name</th><th className="p-3">Faculty Index</th><th className="p-3">Publication Metric</th><th className="p-3">Overall Score</th><th className="p-3">Status</th>
                </tr>
              </thead>
