...
export const Route = createFileRoute("/staff/finance-dean/fee-reports")({
  head: () => ({
    meta: [{ title: "Fee Reports — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Fee Reports</h1>
          <p className="text-sm text-muted-foreground">Fee collection ledgers, pending fee dues, and scholarship reimbursement reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Fee Collected" value="₹23.1 Cr" icon={Wallet} tone="purple" />
        <KpiCard label="Pending Dues" value="₹90.0 Lacs" icon={CreditCard} tone="success" />
        <KpiCard label="Defaulter Ratio" value="3.75%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Fee Reports Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Fee Collected Total</th><th className="p-3">Pending Dues Ratio</th><th className="p-3">Status</th>
                </tr>
              </thead>
