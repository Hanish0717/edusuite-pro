...
export const Route = createFileRoute("/staff/finance-dean/allowances-deductions")({
  head: () => ({
    meta: [{ title: "Allowances & Deductions — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Allowances & Deductions</h1>
          <p className="text-sm text-muted-foreground">PF contribution ledgers, ESI, TDS tax deductions, and DA revision rules.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="PF Remitted" value="₹34.2 Lacs" icon={Wallet} tone="purple" />
        <KpiCard label="TDS Tax Remitted" value="₹28.5 Lacs" icon={CreditCard} tone="success" />
        <KpiCard label="ESI Compliance" value="100%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Allowances & Deductions Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Rule Code</th><th className="p-3">Category</th><th className="p-3">Allowance / Deduction Type</th><th className="p-3">Percentage / Rule</th><th className="p-3">Status</th>
                </tr>
              </thead>
