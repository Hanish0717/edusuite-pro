...
export const Route = createFileRoute("/staff/research-development/completed-projects")({
  head: () => ({
    meta: [{ title: "Completed Projects — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Completed Projects</h1>
          <p className="text-sm text-muted-foreground">Successfully completed research projects and final utilization reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Completed" value="20 Projects" icon={FolderGit2} tone="purple" />
        <KpiCard label="Total Value" value="₹3.05 Cr" icon={BookOpen} tone="success" />
        <KpiCard label="Reports Filed" value="100%" icon={Award} tone="info" />
        <KpiCard label="Status" value="Completed" icon={CheckCircle2} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Completed Projects Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Project ID</th><th className="p-3">Project Title</th><th className="p-3">Principal Investigator</th><th className="p-3">Department</th><th className="p-3">Funding Agency</th><th className="p-3">Final Budget</th><th className="p-3">Completion Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
