...
export const Route = createFileRoute("/staff/examination-dean/grade-sheets")({
  head: () => ({
    meta: [{ title: "Grade Sheets — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Grade Sheets</h1>
          <p className="text-sm text-muted-foreground">Official semester grade sheets, credit points, and transcript generation.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Grade Sheets Printed" value="4,850 Sheets" icon={Users} tone="purple" />
        <KpiCard label="Security Hologram" value="Applied" icon={Calendar} tone="success" />
        <KpiCard label="Dispatched" value="100%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Grade Sheets Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Department</th><th className="p-3">Semester</th><th className="p-3">SGPA</th><th className="p-3">CGPA</th><th className="p-3">Grade Sheet Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
