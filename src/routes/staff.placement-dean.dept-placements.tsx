...
export const Route = createFileRoute("/staff/placement-dean/dept-placements")({
  head: () => ({
    meta: [{ title: "Department-wise Placements — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Department-wise Placements</h1>
          <p className="text-sm text-muted-foreground">Department breakdown of placement percentage, highest CTC, and average CTC.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Departments" value="8 Departments" icon={Building2} tone="purple" />
        <KpiCard label="Top Dept" value="CSE (96.8%)" icon={Users} tone="success" />
        <KpiCard label="Avg CTC Highest" value="CSE (₹16.5 LPA)" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Department-wise Placements Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Department</th><th className="p-3">Eligible Students</th><th className="p-3">Placed Students</th><th className="p-3">Placement %</th><th className="p-3">Highest CTC</th><th className="p-3">Average CTC</th><th className="p-3">Status</th>
                </tr>
              </thead>
