...
export const Route = createFileRoute("/staff/examination-dean/result-reports")({
  head: () => ({
    meta: [{ title: "Result Reports — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Result Reports</h1>
          <p className="text-sm text-muted-foreground">Department pass percentage analysis, grade distribution, and SGPA statistics.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Pass Rate" value="92.6%" icon={Users} tone="purple" />
        <KpiCard label="Gold Medalists" value="8 Rank Holders" icon={Calendar} tone="success" />
        <KpiCard label="BOS Verification" value="Clean" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Result Reports Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Overall Pass %</th><th className="p-3">Top Department</th><th className="p-3">Status</th>
                </tr>
              </thead>
