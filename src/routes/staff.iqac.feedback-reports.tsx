...
export const Route = createFileRoute("/staff/iqac/feedback-reports")({
  head: () => ({
    meta: [{ title: "Feedback Reports — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Feedback Reports</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Feedback Reports" value="8 Reports" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Satisfaction" value="94.5%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Survey Rate" value="98%" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Feedback Reports Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Stakeholder Mapped</th><th className="p-3">Satisfaction Metric</th><th className="p-3">Status</th>
                </tr>
              </thead>
