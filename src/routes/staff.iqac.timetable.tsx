...
export const Route = createFileRoute("/staff/iqac/timetable")({
  head: () => ({
    meta: [{ title: "IQAC Quality & Audit Schedule — EduSuite Pro" }],
  }),
...
function TimetableComponent() {
  ...
  const [selectedClass, setSelectedClass] = useState("NAAC Criteria 1-7 Progress Review");
  ...
  const mySchedule = [
    {
      ...
      subject: "NAAC Criteria 1-7 Progress Review",
      section: "Quality Committee",
      room: "IQAC Boardroom",
      time: "10:00 AM",
      status: "Scheduled"
    },
    {
      ...
      subject: "Academic & Administrative Audit (AAA)",
      section: "CSE & ECE Depts",
      room: "Auditorium-1",
      time: "11:15 AM",
      status: "Scheduled"
    },
    {
      ...
      subject: "Outcome Based Education (OBE) Seminar",
      section: "All Faculty",
      room: "Senate Room",
      time: "09:00 AM",
      status: "Scheduled"
  ...
  const handleAssign = () => {
    const newRecord = {
      ...
      originalFaculty: "Dr. Anand Kumar (IQAC Director)",
      assignedFaculty,
      reason: assignReason,
      status: "Approved",
      approvedBy: "Dr. Anand Kumar (IQAC Director)",
    };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">IQAC Quality & Audit Schedule</h1>
      ...
      {/* TAB 1: MY TIMETABLE */}
      {activeTab === "my" && (
        <Panel title="Dr. Anand Kumar (IQAC Director) — Personal Teaching & Duty Schedule" description="Shows ONLY this dean's own assigned classes, meetings and office hours.">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <Select value={selectedClass} onValueChange={setSelectedClass}>
                  ...
                  <SelectContent>
                    <SelectItem value="NAAC Criteria 1-7 Progress Review">NAAC Criteria 1-7 Progress Review (Quality Committee)</SelectItem>
                    <SelectItem value="Academic & Administrative Audit (AAA)">Academic & Administrative Audit (AAA) (CSE & ECE Depts)</SelectItem>
                    <SelectItem value="Outcome Based Education (OBE) Seminar">Outcome Based Education (OBE) Seminar (All Faculty)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
