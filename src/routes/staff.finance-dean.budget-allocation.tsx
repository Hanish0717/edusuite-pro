...
export const Route = createFileRoute("/staff/finance-dean/budget-allocation")({
  head: () => ({
    meta: [{ title: "Budget Allocation — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Budget Allocation</h1>
          <p className="text-sm text-muted-foreground">Quarterly budget release schedules, capital vs operational expenditure allocations.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Capital Exp" value="₹18.5 Cr" icon={Wallet} tone="purple" />
        <KpiCard label="Operational Exp" value="₹23.5 Cr" icon={CreditCard} tone="success" />
        <KpiCard label="Quarterly Disb" value="Q3 Released" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Budget Allocation Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Allocation Ref</th><th className="p-3">Category</th><th className="p-3">Quarter Scope</th><th className="p-3">Sanctioned Amount</th><th className="p-3">Released Amount</th><th className="p-3">Status</th>
                </tr>
              </thead>
