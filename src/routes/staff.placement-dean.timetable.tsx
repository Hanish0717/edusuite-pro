...
export const Route = createFileRoute("/staff/placement-dean/timetable")({
  head: () => ({
    meta: [{ title: "Placement & Training Schedule — EduSuite Pro" }],
  }),
...
function TimetableComponent() {
  ...
  const [selectedClass, setSelectedClass] = useState("APT101 Corporate Placement Aptitude Training");
  ...
  const mySchedule = [
    {
      ...
      subject: "APT101 Corporate Placement Aptitude Training",
      section: "B.Tech Final Year",
    ...
    },
    {
      ...
      subject: "Tier-1 Recruiter MoU Signing & Drive Prep",
      section: "Google Cloud Team",
      room: "TPO Boardroom",
      time: "11:15 AM",
      status: "Scheduled"
    },
    {
      ...
      subject: "Mock Technical & HR Interview Session",
      section: "Placement Registered",
      room: "TPO Lab 1",
      time: "10:00 AM",
      status: "Scheduled"
    }
  ...
  const handleAssign = () => {
    const newRecord = {
      ...
      originalFaculty: "Prof. Placement Dean",
      assignedFaculty,
      reason: assignReason,
      status: "Approved",
      approvedBy: "Prof. Placement Dean",
    };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Placement & Training Schedule</h1>
      ...
      {/* TAB 1: MY TIMETABLE */}
      {activeTab === "my" && (
        <Panel title="Prof. Placement Dean — Personal Teaching & Duty Schedule" description="Shows ONLY this dean's own assigned classes, meetings and office hours.">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <Select value={selectedClass} onValueChange={setSelectedClass}>
                  ...
                  <SelectContent>
                    <SelectItem value="APT101 Corporate Placement Aptitude Training">APT101 Corporate Placement Aptitude Training (B.Tech Final Year)</SelectItem>
                    <SelectItem value="Tier-1 Recruiter MoU Signing & Drive Prep">Tier-1 Recruiter MoU Signing & Drive Prep (Google Cloud Team)</SelectItem>
                    <SelectItem value="Mock Technical & HR Interview Session">Mock Technical & HR Interview Session (Placement Registered)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
