...
export const Route = createFileRoute("/staff/research-development/journal-publications")({
  head: () => ({
    meta: [{ title: "Journal Publications — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Journal Publications</h1>
          <p className="text-sm text-muted-foreground">SCI, Scopus, & Web of Science indexed journal papers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="SCI Journals" value="185 Papers" icon={FolderGit2} tone="purple" />
        <KpiCard label="Scopus Papers" value="157 Papers" icon={BookOpen} tone="success" />
        <KpiCard label="Avg Impact Factor" value="4.85 IF" icon={Award} tone="info" />
        <KpiCard label="Status" value="Published" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Journal Publications Breakdown Chart" description="Quantitative research metrics across departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Journal Publications Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Title</th><th className="p-3">Authors</th><th className="p-3">Journal Name</th><th className="p-3">Publisher</th><th className="p-3">Scopus / SCI</th><th className="p-3">DOI</th><th className="p-3">Year</th><th className="p-3">Status</th>
                </tr>
              </thead>
