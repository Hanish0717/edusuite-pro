...
export const Route = createFileRoute("/staff/placement-dean/aptitude-training")({
  head: () => ({
    meta: [{ title: "Aptitude Training — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Aptitude Training</h1>
          <p className="text-sm text-muted-foreground">Quantitative aptitude, logical reasoning, and verbal training modules.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Training Hours" value="120 Hours" icon={Building2} tone="purple" />
        <KpiCard label="Students Trained" value="1,850 Students" icon={Users} tone="success" />
        <KpiCard label="Pass Score Avg" value="86.5%" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Completed" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Aptitude Training Distribution Chart" description="Quantitative placement metrics across academic departments and recruiters.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Aptitude Training Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Training Program</th><th className="p-3">Trainer Agency / Faculty</th><th className="p-3">Department Scope</th><th className="p-3">Schedule</th><th className="p-3">Attendance %</th><th className="p-3">Completion %</th><th className="p-3">Status</th>
                </tr>
              </thead>
