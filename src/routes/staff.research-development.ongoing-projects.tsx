...
export const Route = createFileRoute("/staff/research-development/ongoing-projects")({
  head: () => ({
    meta: [{ title: "Ongoing Projects — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Ongoing Projects</h1>
          <p className="text-sm text-muted-foreground">Active sponsored research projects, principal investigators, and funding agencies.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Active Projects" value="28 Active" icon={FolderGit2} tone="purple" />
        <KpiCard label="Total Budget" value="₹5.40 Cr" icon={BookOpen} tone="success" />
        <KpiCard label="Lead PIs" value="24 Faculty" icon={Award} tone="info" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Ongoing Projects Breakdown Chart" description="Quantitative research metrics across departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Ongoing Projects Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Project ID</th><th className="p-3">Project Title</th><th className="p-3">Principal Investigator</th><th className="p-3">Department</th><th className="p-3">Funding Agency</th><th className="p-3">Budget</th><th className="p-3">Duration</th><th className="p-3">Status</th>
                </tr>
              </thead>
