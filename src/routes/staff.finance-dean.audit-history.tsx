...
export const Route = createFileRoute("/staff/finance-dean/audit-history")({
  head: () => ({
    meta: [{ title: "Audit History — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Audit History</h1>
          <p className="text-sm text-muted-foreground">Historical audit archives, past balance sheets, and audit clearance certificates.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Archives" value="10 Years" icon={Wallet} tone="purple" />
        <KpiCard label="Audit Objections" value="0 Pending" icon={CreditCard} tone="success" />
        <KpiCard label="Statutory Clearance" value="100%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Audit History Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Financial Year</th><th className="p-3">Audit Type</th><th className="p-3">Auditor Name</th><th className="p-3">Clearance Certificate</th><th className="p-3">Status</th>
                </tr>
              </thead>
