...
export const Route = createFileRoute("/staff/iqac/ssr")({
  head: () => ({
    meta: [{ title: "SSR Management — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">SSR Management</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="SSR Indicators" value="115 Metrics" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Compliance" value="96.4%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Standard" value="Grade A++" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="SSR Management Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Metric Code</th><th className="p-3">Indicator Description</th><th className="p-3">Target Standard</th><th className="p-3">Current Score</th><th className="p-3">Variance %</th><th className="p-3">Status</th>
                </tr>
              </thead>
