...
export const Route = createFileRoute("/staff/examination-dean/semester-exams")({
  head: () => ({
    meta: [{ title: "Semester Exams — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Semester Exams</h1>
          <p className="text-sm text-muted-foreground">End-semester main theory examination schedule and attendance ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Semester Exams" value="184 Exams" icon={Users} tone="purple" />
        <KpiCard label="Present Rate" value="98.2%" icon={Calendar} tone="success" />
        <KpiCard label="Attendance Pass" value="98.2%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Semester Exams Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Subject Code</th><th className="p-3">Subject Title</th><th className="p-3">Department</th><th className="p-3">Exam Date</th><th className="p-3">Present Students</th><th className="p-3">Absent Students</th><th className="p-3">Status</th>
                </tr>
              </thead>
