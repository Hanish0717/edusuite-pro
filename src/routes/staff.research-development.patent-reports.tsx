...
export const Route = createFileRoute("/staff/research-development/patent-reports")({
  head: () => ({
    meta: [{ title: "Patent Reports — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Patent Reports</h1>
          <p className="text-sm text-muted-foreground">Patent filing ledgers, granted patent dossiers, and IPR metrics.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Patents" value="42 Filed / 18 Granted" icon={FolderGit2} tone="purple" />
        <KpiCard label="Commercialized" value="4 Patents" icon={BookOpen} tone="success" />
        <KpiCard label="Royalty Value" value="₹45.0 Lacs" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Patent Reports Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Patents Included</th><th className="p-3">Commercialization Value</th><th className="p-3">Status</th>
                </tr>
              </thead>
