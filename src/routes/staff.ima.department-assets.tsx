...
export const Route = createFileRoute("/staff/ima/department-assets")({
  head: () => ({
    meta: [{ title: "Department Assets — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Department-wise asset allocation breakdown and valuation ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="CSE Assets" value="₹1.85 Cr" icon={FlaskConical} tone="purple" />
        <KpiCard label="ECE Assets" value="₹1.40 Cr" icon={Cpu} tone="success" />
        <KpiCard label="ME Assets" value="₹95.0 Lacs" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Department Assets Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Department</th><th className="p-3">Lab Count</th><th className="p-3">Equipment Count</th><th className="p-3">Asset Valuation</th><th className="p-3">Department HOD</th><th className="p-3">Status</th>
                </tr>
              </thead>
