...
export const Route = createFileRoute("/staff/research-development/fdps")({
  head: () => ({
    meta: [{ title: "FDPs — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">FDPs</h1>
          <p className="text-sm text-muted-foreground">Faculty Development Programs on Research Methodology and IPR.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="FDPs Organized" value="8 Programs" icon={FolderGit2} tone="purple" />
        <KpiCard label="Faculty Participants" value="180 Faculty" icon={BookOpen} tone="success" />
        <KpiCard label="Certificates" value="Issued" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="FDPs Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">FDP Title</th><th className="p-3">Target Audience</th><th className="p-3">Dates</th><th className="p-3">Participants</th><th className="p-3">Status</th>
                </tr>
              </thead>
