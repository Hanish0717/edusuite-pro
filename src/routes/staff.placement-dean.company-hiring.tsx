...
export const Route = createFileRoute("/staff/placement-dean/company-hiring")({
  head: () => ({
    meta: [{ title: "Company-wise Hiring — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Company-wise Hiring</h1>
          <p className="text-sm text-muted-foreground">Recruiter-wise total selections, CTC range, and department breakdown.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Recruiters" value="142 Companies" icon={Building2} tone="purple" />
        <KpiCard label="Top Recruiter" value="TCS (240 Offers)" icon={Users} tone="success" />
        <KpiCard label="SLA Clearance" value="Passed" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Company-wise Hiring Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Total Offers Dispatched</th><th className="p-3">Package Offered</th><th className="p-3">Top Department Hired</th><th className="p-3">Status</th>
                </tr>
              </thead>
