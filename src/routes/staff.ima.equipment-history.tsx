...
export const Route = createFileRoute("/staff/ima/equipment-history")({
  head: () => ({
    meta: [{ title: "Equipment History — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Complete service timeline, upgrades, transfers, and maintenance logs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="History Logs" value="2,480 Logs" icon={FlaskConical} tone="purple" />
        <KpiCard label="RAM Upgrades" value="180 PCs" icon={Cpu} tone="success" />
        <KpiCard label="Serviced" value="100%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Equipment History Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Equipment ID</th><th className="p-3">Equipment Name</th><th className="p-3">Lifecycle Event</th><th className="p-3">Action Taken</th><th className="p-3">Performed Date</th><th className="p-3">Handled By</th><th className="p-3">Status</th>
                </tr>
              </thead>
