...
export const Route = createFileRoute("/staff/research-development/conferences")({
  head: () => ({
    meta: [{ title: "Conferences — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Conferences</h1>
          <p className="text-sm text-muted-foreground">IEEE & International research conferences organized by R&D Cell.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Conferences" value="4 International" icon={FolderGit2} tone="purple" />
        <KpiCard label="Delegates" value="850 Delegates" icon={BookOpen} tone="success" />
        <KpiCard label="IEEE Papers" value="120 Papers" icon={Award} tone="info" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Conferences Breakdown Chart" description="Quantitative research metrics across departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Conferences Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Conference Title</th><th className="p-3">Scope / Tier</th><th className="p-3">Organizing Dept</th><th className="p-3">Dates</th><th className="p-3">Venue</th><th className="p-3">Status</th>
                </tr>
              </thead>
