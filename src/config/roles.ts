...
export const ERP_MODULES = [
  ...
  { id: "procurement", name: "Procurement", icon: Building2 },
  { id: "events", name: "Campus Events", icon: GraduationCap },
  { id: "employee-management", name: "Employee Management", icon: UserCog },
  { id: "leave", name: "Leave Management", icon: UserCog },
