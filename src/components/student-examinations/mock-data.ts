...
export const MOCK_EXAM_REGISTRATIONS: ExamRegistrationItem[] = [
  ...
  },
  {
    ...
    examType: "Regular",
    subjectCode: "NP301",
    subjectName: "Introduction to IoT (NPTEL)",
    credits: 3.0,
    feeAmount: 500,
    lateFee: 0,
    paymentStatus: "Paid",
    registrationDeadline: "Feb 05, 2025",
    examCentrePreference: "Main Campus - Block C",
    status: "Approved",
    receiptNumber: "EXM-REC-9016",
  },
];
...
export const MOCK_UPCOMING_EXAMS: UpcomingExamItem[] = [
  ...
  },
  {
    ...
    subjectCode: "NP301",
    subjectName: "Introduction to IoT (NPTEL)",
    examDate: "Feb 19, 2025",
    timeSlot: "09:30 AM - 12:30 PM",
    duration: "3 Hours",
    hallNumber: "Block C - 105",
    seatNumber: "C-24",
    credits: 3.0,
    type: "Elective",
    status: "Scheduled",
...
export const MOCK_SEMESTER_RESULTS: SemesterResultItem[] = [
  ...
  },
  {
    ...
    category: "Regular",
    subjects: [
      { code: "CS301", name: "Computer Networks", internal: 38, external: 56, total: 94, grade: "O", credits: 3.0, status: "Pass" },
      { code: "CS302", name: "Database Management Systems", internal: 36, external: 54, total: 90, grade: "O", credits: 4.0, status: "Pass" },
      { code: "CS303", name: "Advanced Java Programming Lab", internal: 38, external: 57, total: 95, grade: "O", credits: 1.5, status: "Pass" },
      { code: "OE311", name: "Intellectual Property Rights", internal: 31, external: 44, total: 75, grade: "A", credits: 3.0, status: "Pass" },
      { code: "NP301", name: "Introduction to IoT (NPTEL)", internal: 35, external: 50, total: 85, grade: "A+", credits: 3.0, status: "Pass" },
    ],
  },
  {
    semester: 6,
