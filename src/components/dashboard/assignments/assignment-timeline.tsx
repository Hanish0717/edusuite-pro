...
export function AssignmentTimeline({ timeline }: AssignmentTimelineProps) {
  return (
    <Panel
      title="Assignment Event Audit Log"
      description="System milestones tracking sheet publication, submissions, and grading checks"
