...
export function StudentEventsCard({ events, onOpenEventDetails }: StudentEventsProps) {
  const [selectedCategory, setSelectedCategory] = useState<string>("All");

  const categories = ["All", "Examination", "Assignment", "Hackathon", "Placement", "Workshop"];
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">
              Upcoming Academic Events & Drives
            </h3>
            <p className="text-[11px] text-slate-500 font-medium">
              Examinations, Placement Drives, Deadlines & Workshops
            </p>
          </div>
        </div>
