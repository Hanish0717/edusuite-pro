...
console.log("Starting upgrading all subpages across 8 executive Deans with 100% interactivity...");

// ==========================================
// 1. ACADEMIC DEAN SUBPAGES
// ==========================================
writeInteractivePage("staff.academic-dean.departments.tsx", "/staff/academic-dean/departments", "Academic Dean", "Departments", "Master academic departments directory, HODs, faculty count, and student strength.", "ACADEMIC MANAGEMENT", [{ label: "Departments", val: "9 Departments" }, { label: "Total Faculty", val: "345 Faculty" }, { label: "Total Students", val: "5,820 Students" }, { label: "Accreditation", val: "100% NBA/NAAC" }], ["Dept Code", "Department Name", "Head of Department (HOD)", "Faculty Count", "Student Count", "Programs", "Status"], `[
...
writeInteractivePage("staff.academic-dean.curriculum.tsx", "/staff/academic-dean/curriculum", "Academic Dean", "Curriculum & Syllabus", "BOS approved curriculum revisions, syllabus structures, and regulation schemes.", "ACADEMIC MANAGEMENT", [{ label: "Regulations", val: "R24 Scheme" }, { label: "Syllabus Revisions", val: "100% Up to Date" }, { label: "OBE Aligned", val: "Verified" }, { label: "Status", val: "Approved" }], ["Regulation Scheme", "Department", "Degree Program", "Syllabus Status", "BOS Approval Date", "Status"], `[
...
writeInteractivePage("staff.academic-dean.attendance-monitoring.tsx", "/staff/academic-dean/attendance-monitoring", "Academic Dean", "Attendance Monitoring", "Campus-wide student attendance monitoring, shortage alerts, and condonation ledgers.", "STUDENT ACADEMICS", [{ label: "Overall Attendance", val: "91.2%" }, { label: "Eligible (>75%)", val: "5,310 Students" }, { label: "Shortage (<75%)", val: "510 Students" }, { label: "Status", val: "Active" }], ["Roll Number", "Student Name", "Department", "Semester", "Overall Attendance %", "Shortage Status", "Status"], `[
...
writeInteractivePage("staff.academic-dean.faculty-timetable.tsx", "/staff/academic-dean/faculty-timetable", "Academic Dean", "Faculty Timetable", "Master faculty teaching schedules, period breakdown, and room allocations.", "TIMETABLE MANAGEMENT", [{ label: "Faculty Mapped", val: "345 Faculty" }, { label: "Weekly Periods", val: "4,850 Periods" }, { label: "Conflict Free", val: "100%" }, { label: "Status", val: "Active" }], ["Faculty Name", "Employee ID", "Department", "Subject", "Weekly Teaching Load", "Allocated Room", "Status"], `[
...
writeInteractivePage("staff.academic-dean.subject-allocation.tsx", "/staff/academic-dean/subject-allocation", "Academic Dean", "Subject Allocation", "Semester subject allocation to faculty based on domain expertise.", "FACULTY WORKLOAD", [{ label: "Subjects Allocated", val: "248 Subjects" }, { label: "Expertise Mapped", val: "100%" }, { label: "HOD Signed", val: "Verified" }, { label: "Status", val: "Approved" }], ["Subject Code", "Subject Name", "Department", "Allocated Faculty", "Semester", "Status"], `[
  { code: "CS501", name: "Advanced Software Engineering", dept: "CSE", fac: "Dr. Srinivas Rao", sem: "Semester 5", status: "Approved" }
]`);

writeInteractivePage("staff.academic-dean.dept-workload.tsx", "/staff/academic-dean/dept-workload", "Academic Dean", "Department Workload", "Department-level faculty strength, student-teacher ratio (STR 1:15), and load balance.", "FACULTY WORKLOAD", [{ label: "STR Ratio Avg", val: "1:16.8" }, { label: "Total Load", val: "5,520 Hours / Wk" }, { label: "Load Balance", val: "Optimal" }, { label: "Status", val: "Balanced" }], ["Department", "Faculty Count", "Student Count", "STR Ratio", "Total Workload Hours", "Status"], `[
