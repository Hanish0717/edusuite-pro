...
export const Route = createFileRoute("/staff/placement-dean/internship-tracking")({
  head: () => ({
    meta: [{ title: "Internship Tracking — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Internship Tracking</h1>
          <p className="text-sm text-muted-foreground">Real-time internship progress monitoring, monthly attendance, and mentor evaluation.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Active Interns" value="420 Students" icon={Building2} tone="purple" />
        <KpiCard label="Attendance Rate" value="98.5%" icon={Users} tone="success" />
        <KpiCard label="Monthly Log Clearance" value="100%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Internship Tracking Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Company</th><th className="p-3">Mentor Name</th><th className="p-3">Progress Rating</th><th className="p-3">Status</th>
                </tr>
              </thead>
