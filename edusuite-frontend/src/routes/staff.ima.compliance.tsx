...
export const Route = createFileRoute("/staff/ima/compliance")({
  head: () => ({
    meta: [{ title: "Regulatory & Safety Compliance — EduSuite Pro" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Regulatory & Safety Compliance</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Compliance Score" value="100%" icon={Building2} tone="info" />
        <KpiCard label="Fire Safety" value="NFPA Certified" icon={Users} tone="success" />
        <KpiCard label="PCB Norms" value="Compliant" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Verified" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="Regulatory & Safety Compliance Ledger" description="Official domain records & ERP status.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Audit Area</th><th className="p-3">Regulatory Standard</th><th className="p-3">Compliance Level</th><th className="p-3">Status</th>
                </tr>
              </thead>
