...
export const Route = createFileRoute("/staff/placement-dean/resume-reviews")({
  head: () => ({
    meta: [{ title: "Resume Reviews — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Resume Reviews</h1>
          <p className="text-sm text-muted-foreground">ATS resume formatting, keyword optimization, and placement cell verification.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Resumes Reviewed" value="1,850 Resumes" icon={Building2} tone="purple" />
        <KpiCard label="ATS Score Avg" value="88 / 100" icon={Users} tone="success" />
        <KpiCard label="NOC Issued" value="100%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Resume Reviews Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Department</th><th className="p-3">ATS Score</th><th className="p-3">Reviewer Faculty</th><th className="p-3">Status</th>
                </tr>
              </thead>
