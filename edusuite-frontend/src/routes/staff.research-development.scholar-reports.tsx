...
export const Route = createFileRoute("/staff/research-development/scholar-reports")({
  head: () => ({
    meta: [{ title: "Scholar Reports — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Scholar Reports</h1>
          <p className="text-sm text-muted-foreground">PhD scholar progress reports, thesis submissions, and viva outcomes.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="PhD Scholars" value="145 Scholars" icon={FolderGit2} tone="purple" />
        <KpiCard label="Theses Awarded" value="68 Degrees" icon={BookOpen} tone="success" />
        <KpiCard label="SLA Clearance" value="98.5%" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Scholar Reports Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Scholars Tracked</th><th className="p-3">DC Review Clearance</th><th className="p-3">Status</th>
                </tr>
              </thead>
