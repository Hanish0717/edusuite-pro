...
export const Route = createFileRoute("/staff/research-development/lab-booking")({
  head: () => ({
    meta: [{ title: "Lab Booking — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Research lab slot reservation for scholars & experimental trials.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Bookings" value="42 Bookings" icon={FolderGit2} tone="purple" />
        <KpiCard label="Approved" value="100%" icon={BookOpen} tone="success" />
        <KpiCard label="Active Slots" value="18 Slots" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Lab Booking Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Booking ID</th><th className="p-3">Scholar Name</th><th className="p-3">Research Lab</th><th className="p-3">Slot Time</th><th className="p-3">Purpose</th><th className="p-3">Status</th>
                </tr>
              </thead>
