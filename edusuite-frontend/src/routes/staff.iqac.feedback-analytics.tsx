...
export const Route = createFileRoute("/staff/iqac/feedback-analytics")({
  head: () => ({
    meta: [{ title: "Feedback Analytics — IQAC Dean" }],
  }),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Overall Sentiment" value="94.5% Positive" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Target Score" value="4.50 Benchmark" icon={ShieldCheck} tone="success" />
        <KpiCard label="Satisfaction" value="Exceeds Target" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Feedback Analytics Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Stakeholder Group</th><th className="p-3">Sample Count</th><th className="p-3">Satisfaction Rate</th><th className="p-3">Benchmark Target</th><th className="p-3">Status</th>
                </tr>
              </thead>
