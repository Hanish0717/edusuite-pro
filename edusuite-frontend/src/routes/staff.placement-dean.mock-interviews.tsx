...
export const Route = createFileRoute("/staff/placement-dean/mock-interviews")({
  head: () => ({
    meta: [{ title: "Mock Interviews — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Alumni & industry expert 1-on-1 mock technical & HR interviews.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Mock Interviews Held" value="1,820 Interviews" icon={Building2} tone="purple" />
        <KpiCard label="Alumni Panelists" value="45 Alumni Experts" icon={Users} tone="success" />
        <KpiCard label="Readiness Index" value="94.5%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Mock Interviews Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Department</th><th className="p-3">Panelist Name</th><th className="p-3">Interview Score</th><th className="p-3">Feedback</th><th className="p-3">Status</th>
                </tr>
              </thead>
