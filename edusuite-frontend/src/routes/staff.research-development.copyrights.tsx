...
export const Route = createFileRoute("/staff/research-development/copyrights")({
  head: () => ({
    meta: [{ title: "Copyrights — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Copyrights</h1>
          <p className="text-sm text-muted-foreground">Software code copyrights, algorithms, & manual registrations.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Copyrights Registered" value="24 Filed" icon={FolderGit2} tone="purple" />
        <KpiCard label="Approved" value="20 Granted" icon={BookOpen} tone="success" />
        <KpiCard label="Software Code" value="18 Algorithms" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Copyrights Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">CR Reg No</th><th className="p-3">Copyright Title</th><th className="p-3">Authors / Developers</th><th className="p-3">Registration Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
