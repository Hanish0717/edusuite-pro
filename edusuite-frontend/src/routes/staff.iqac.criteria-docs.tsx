...
export const Route = createFileRoute("/staff/iqac/criteria-docs")({
  head: () => ({
    meta: [{ title: "Criteria Documentation — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Criteria Documentation</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Proof Files" value="1,240 Files" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Criteria Mapped" value="7 Criteria" icon={ShieldCheck} tone="success" />
        <KpiCard label="Verification" value="100% Valid" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Criteria Documentation Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Doc Ref</th><th className="p-3">NAAC Criteria Mapped</th><th className="p-3">Document Title</th><th className="p-3">File Format</th><th className="p-3">Status</th>
                </tr>
              </thead>
