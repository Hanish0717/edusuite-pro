...
export const Route = createFileRoute("/staff/iqac/reports")({
  head: () => ({
    meta: [{ title: "IQAC Quality Reports — EduSuite Pro" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">IQAC Quality Reports</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Reports" value="18 Dossiers" icon={Building2} tone="info" />
        <KpiCard label="NAAC Certified" value="Yes" icon={Users} tone="success" />
        <KpiCard label="AQAR Ledger" value="Clean Pass" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="IQAC Quality Reports Ledger" description="Official domain records & ERP status.">
