...
export const Route = createFileRoute("/staff/examination-dean/invigilator-reports")({
  head: () => ({
    meta: [{ title: "Invigilator Reports — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Invigilator Reports</h1>
          <p className="text-sm text-muted-foreground">Faculty invigilation duty attendance, duty load compliance, and honorarium audit.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Faculty Duties" value="368 Sessions" icon={Users} tone="purple" />
        <KpiCard label="Duty Compliance" value="100%" icon={Calendar} tone="success" />
        <KpiCard label="Honorarium Disb" value="Cleared" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Invigilator Reports Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Total Duties</th><th className="p-3">Compliance Score</th><th className="p-3">Status</th>
                </tr>
              </thead>
