...
export const Route = createFileRoute("/staff/examination-dean/internal-exams")({
  head: () => ({
    meta: [{ title: "Internal Exams — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Internal Exams</h1>
          <p className="text-sm text-muted-foreground">Continuous internal evaluation (CIE), quiz marks, and assignment marks.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="CIE Weightage" value="40 Marks" icon={Users} tone="purple" />
        <KpiCard label="Tests Held" value="2 CIE Tests" icon={Calendar} tone="success" />
        <KpiCard label="Entry Completion" value="98.5%" icon={Ticket} tone="info" />
        <KpiCard label="Status" value="Completed" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Internal Exams Statistics Chart" description="Quantitative examination ledgers across academic departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Internal Exams Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Subject Code</th><th className="p-3">Subject Title</th><th className="p-3">Department</th><th className="p-3">Internal Test #</th><th className="p-3">Average Marks</th><th className="p-3">Entry Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
