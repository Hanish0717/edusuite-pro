...
export const Route = createFileRoute("/staff/ima/asset-disposal")({
  head: () => ({
    meta: [{ title: "Asset Disposal — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Asset Disposal</h1>
          <p className="text-sm text-muted-foreground">E-waste disposal, scrapped equipment ledger, and auction records.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Disposed Assets" value="8 Units" icon={FlaskConical} tone="purple" />
        <KpiCard label="E-Waste Cleared" value="Certified" icon={Cpu} tone="success" />
        <KpiCard label="Auction Value" value="₹1.2 Lacs" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Asset Disposal Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Disposal Ref</th><th className="p-3">Equipment Name</th><th className="p-3">Disposal Reason</th><th className="p-3">Scrap Value</th><th className="p-3">Disposal Date</th><th className="p-3">E-Waste Certificate</th><th className="p-3">Status</th>
                </tr>
              </thead>
