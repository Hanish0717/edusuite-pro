...
export const Route = createFileRoute("/staff/ima/maintenance-schedule")({
  head: () => ({
    meta: [{ title: "Maintenance Schedule — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Maintenance Schedule</h1>
          <p className="text-sm text-muted-foreground">Preventive maintenance calendar, quarterly lab servicing & inspection.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Scheduled Visits" value="6 Visits" icon={FlaskConical} tone="purple" />
        <KpiCard label="Quarterly Audit" value="Q3 2026" icon={Cpu} tone="success" />
        <KpiCard label="SLA Pass Rate" value="99.0%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Maintenance Schedule Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Schedule Ref</th><th className="p-3">Maintenance Type</th><th className="p-3">Laboratory Scope</th><th className="p-3">Vendor / Tech</th><th className="p-3">Scheduled Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
