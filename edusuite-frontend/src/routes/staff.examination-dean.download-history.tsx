...
export const Route = createFileRoute("/staff/examination-dean/download-history")({
  head: () => ({
    meta: [{ title: "Download History — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Download History</h1>
          <p className="text-sm text-muted-foreground">Student hall ticket download logs, IP timestamps, and verified downloads.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Downloads Logged" value="4,680 Downloads" icon={Users} tone="purple" />
        <KpiCard label="Download Rate" value="96.5%" icon={Calendar} tone="success" />
        <KpiCard label="IP Audit" value="Passed" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Download History Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Hall Ticket Number</th><th className="p-3">Download Timestamp</th><th className="p-3">IP Address</th><th className="p-3">Status</th>
                </tr>
              </thead>
