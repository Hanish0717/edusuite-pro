...
export const Route = createFileRoute("/staff/research-development/industry-grants")({
  head: () => ({
    meta: [{ title: "Industry Grants — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Industry Grants</h1>
          <p className="text-sm text-muted-foreground">Corporate sponsored R&D grants and CSR research funding.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Industry Grants" value="6 Grants" icon={FolderGit2} tone="purple" />
        <KpiCard label="Total Fund" value="₹1.25 Cr" icon={BookOpen} tone="success" />
        <KpiCard label="Corporate Partners" value="Google, L&T, Intel" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Industry Grants Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Grant Code</th><th className="p-3">Corporate Sponsor</th><th className="p-3">Research Focus</th><th className="p-3">Grant Amount</th><th className="p-3">PI Name</th><th className="p-3">Status</th>
                </tr>
              </thead>
