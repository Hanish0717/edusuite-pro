...
export const Route = createFileRoute("/staff/examination-dean/hall-ticket-status")({
  head: () => ({
    meta: [{ title: "Hall Ticket Status — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Hall Ticket Status</h1>
          <p className="text-sm text-muted-foreground">Student hall ticket dispatch status, attendance eligibility, and fee NOC.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Hall Tickets Issued" value="4,850 Issued" icon={Users} tone="purple" />
        <KpiCard label="Withheld (Attendance)" value="120 Students" icon={Calendar} tone="success" />
        <KpiCard label="Attendance Pass" value="97.5%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Hall Ticket Status Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Department</th><th className="p-3">Semester</th><th className="p-3">Attendance %</th><th className="p-3">Hall Ticket Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
