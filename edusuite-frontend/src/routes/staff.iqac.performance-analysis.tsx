...
export const Route = createFileRoute("/staff/iqac/performance-analysis")({
  head: () => ({
    meta: [{ title: "Performance Analysis — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Performance Analysis</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="5-Year Growth" value="+18.4%" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Academic SLA" value="99.2%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Quality Rating" value="Grade A++" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Performance Analysis Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Academic Year</th><th className="p-3">NAAC Score Trend</th><th className="p-3">AQAR Score</th><th className="p-3">Overall Performance</th><th className="p-3">Status</th>
                </tr>
              </thead>
