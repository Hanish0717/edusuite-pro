...
export const Route = createFileRoute("/staff/examination-dean/invigilator-allocation")({
  head: () => ({
    meta: [{ title: "Invigilator Allocation — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Invigilator Allocation</h1>
          <p className="text-sm text-muted-foreground">Faculty invigilation duty assignment, hall duty rosters, and substitute invigilators.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Faculty Assigned" value="245 Faculty" icon={Users} tone="purple" />
        <KpiCard label="Invigilation Duties" value="368 Sessions" icon={Calendar} tone="success" />
        <KpiCard label="Duty Load Avg" value="3 Duties / Faculty" icon={Ticket} tone="info" />
        <KpiCard label="Status" value="Assigned" icon={Award} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Invigilator Allocation Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Faculty Name</th><th className="p-3">Department</th><th className="p-3">Assigned Exam Hall</th><th className="p-3">Exam Date</th><th className="p-3">Session Slot</th><th className="p-3">Duty Status</th><th className="p-3">Status</th>
                </tr>
              </thead>
