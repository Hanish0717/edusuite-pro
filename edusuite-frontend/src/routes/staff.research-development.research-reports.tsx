...
export const Route = createFileRoute("/staff/research-development/research-reports")({
  head: () => ({
    meta: [{ title: "Research Reports — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Research Reports</h1>
          <p className="text-sm text-muted-foreground">Annual institutional research dossiers and research performance audits.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Reports Archived" value="12 Reports" icon={FolderGit2} tone="purple" />
        <KpiCard label="Research Score" value="Grade A++" icon={BookOpen} tone="success" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Research Reports Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Scope</th><th className="p-3">Generated Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
