...
export const Route = createFileRoute("/staff/research-development/grant-utilization")({
  head: () => ({
    meta: [{ title: "Grant Utilization — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Grant Utilization</h1>
          <p className="text-sm text-muted-foreground">Financial utilization certificates (UC) and audit clearances.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Total Received" value="₹8.45 Cr" icon={FolderGit2} tone="purple" />
        <KpiCard label="Utilized" value="₹6.80 Cr (80.4%)" icon={BookOpen} tone="success" />
        <KpiCard label="UC Submitted" value="100%" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Grant Utilization Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Grant Ref</th><th className="p-3">Agency</th><th className="p-3">Sanctioned Amount</th><th className="p-3">Utilized Amount</th><th className="p-3">UC Status</th><th className="p-3">Auditor Clearance</th><th className="p-3">Status</th>
                </tr>
              </thead>
