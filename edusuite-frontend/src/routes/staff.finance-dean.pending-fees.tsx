...
export const Route = createFileRoute("/staff/finance-dean/pending-fees")({
  head: () => ({
    meta: [{ title: "Pending Fees — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Pending Fees</h1>
          <p className="text-sm text-muted-foreground">Student fee defaulter ledgers, pending fee dues, and installment reminders.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Pending Fees Total" value="₹90.0 Lacs" icon={Wallet} tone="purple" />
        <KpiCard label="Defaulter Students" value="120 Students" icon={CreditCard} tone="success" />
        <KpiCard label="Due Date" value="15-Aug-2026" icon={TrendingUp} tone="info" />
        <KpiCard label="Status" value="Pending" icon={ShieldCheck} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Pending Fees Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Department</th><th className="p-3">Fee Type</th><th className="p-3">Total Due</th><th className="p-3">Paid Amount</th><th className="p-3">Pending Balance</th><th className="p-3">Status</th>
                </tr>
              </thead>
