...
export const Route = createFileRoute("/staff/placement-dean/soft-skills")({
  head: () => ({
    meta: [{ title: "Soft Skills — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Soft Skills</h1>
          <p className="text-sm text-muted-foreground">Corporate etiquette, group discussions (GD), and presentation skills workshops.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="GD Workshops" value="40 Sessions" icon={Building2} tone="purple" />
        <KpiCard label="Soft Skill Rating" value="Excellent" icon={Users} tone="success" />
        <KpiCard label="Attendance Rate" value="97.8%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Soft Skills Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Workshop Title</th><th className="p-3">Corporate Trainer</th><th className="p-3">Target Group</th><th className="p-3">Session Scope</th><th className="p-3">Status</th>
                </tr>
              </thead>
