...
export const Route = createFileRoute("/staff/examination-dean/cgpa-calculation")({
  head: () => ({
    meta: [{ title: "CGPA Calculation — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">CGPA Calculation</h1>
          <p className="text-sm text-muted-foreground">Cumulative Grade Point Average (CGPA) credit weightage calculation ledger.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Students Calculated" value="5,420 Students" icon={Users} tone="purple" />
        <KpiCard label="Formula Mapped" value="CBCS / OBE 10-Point Scale" icon={Calendar} tone="success" />
        <KpiCard label="Credit Audit" value="Verified" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="CGPA Calculation Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Total Credits</th><th className="p-3">Earned Credits</th><th className="p-3">SGPA</th><th className="p-3">CGPA</th><th className="p-3">Status</th>
                </tr>
              </thead>
