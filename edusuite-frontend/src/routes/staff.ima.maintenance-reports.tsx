...
export const Route = createFileRoute("/staff/ima/maintenance-reports")({
  head: () => ({
    meta: [{ title: "Maintenance Reports — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Maintenance Reports</h1>
          <p className="text-sm text-muted-foreground">Maintenance tickets resolution history, AMC status, and downtime logs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Tickets Resolved" value="84 Tickets" icon={FlaskConical} tone="purple" />
        <KpiCard label="Avg Resolution" value="24 Hrs" icon={Cpu} tone="success" />
        <KpiCard label="SLA Pass" value="98.5%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Maintenance Reports Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Tickets Logged</th><th className="p-3">Resolution SLA</th><th className="p-3">Status</th>
                </tr>
              </thead>
