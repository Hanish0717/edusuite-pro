...
export const Route = createFileRoute("/staff/examination-dean/mid-exams")({
  head: () => ({
    meta: [{ title: "Mid Exams — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Mid Exams</h1>
          <p className="text-sm text-muted-foreground">Mid-semester examination timetables, evaluation, and score ledgers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Mid Exams" value="2 Mid Terms" icon={Users} tone="purple" />
        <KpiCard label="Students Evaluated" value="5,420 Students" icon={Calendar} tone="success" />
        <KpiCard label="Pass Score" value="89.2%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Mid Exams Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Mid Ref</th><th className="p-3">Subject Code</th><th className="p-3">Department</th><th className="p-3">Exam Date</th><th className="p-3">Evaluated Count</th><th className="p-3">Average Score</th><th className="p-3">Status</th>
                </tr>
              </thead>
