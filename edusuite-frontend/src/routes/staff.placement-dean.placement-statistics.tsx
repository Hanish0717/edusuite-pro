...
export const Route = createFileRoute("/staff/placement-dean/placement-statistics")({
  head: () => ({
    meta: [{ title: "Placement Statistics — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Placement Statistics</h1>
          <p className="text-sm text-muted-foreground">Master campus placement rate analytics, year-on-year growth, and offer distribution.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Overall Placement" value="89.6%" icon={Building2} tone="purple" />
        <KpiCard label="Offers Generated" value="1,640 Offers" icon={Users} tone="success" />
        <KpiCard label="Highest CTC" value="₹52.0 LPA" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Verified" icon={Award} tone="warning" />
      </div>

      
      <Panel title="Placement Statistics Distribution Chart" description="Quantitative placement metrics across academic departments and recruiters.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Placement Statistics Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Metric Title</th><th className="p-3">Current Session 2025-26</th><th className="p-3">Previous Session 2024-25</th><th className="p-3">YoY Growth</th><th className="p-3">Status</th>
                </tr>
              </thead>
