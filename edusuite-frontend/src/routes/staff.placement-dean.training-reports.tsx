...
export const Route = createFileRoute("/staff/placement-dean/training-reports")({
  head: () => ({
    meta: [{ title: "Training Reports — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Aptitude, coding, and soft skills training effectiveness & score improvement reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Training Programs" value="12 Modules" icon={Building2} tone="purple" />
        <KpiCard label="Score Gain" value="+28% Avg" icon={Users} tone="success" />
        <KpiCard label="Completion Rate" value="100%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Training Reports Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Total Hours</th><th className="p-3">Score Gain Avg</th><th className="p-3">Status</th>
                </tr>
              </thead>
