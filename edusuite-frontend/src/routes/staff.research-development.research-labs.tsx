...
export const Route = createFileRoute("/staff/research-development/research-labs")({
  head: () => ({
    meta: [{ title: "Research Labs — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Research Labs</h1>
          <p className="text-sm text-muted-foreground">Dedicated R&D laboratories, supercomputing nodes, and lab incharge.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="R&D Labs" value="8 Specialized Labs" icon={FolderGit2} tone="purple" />
        <KpiCard label="GPU Nodes" value="32 Nodes" icon={BookOpen} tone="success" />
        <KpiCard label="Scholars" value="98 Users" icon={Award} tone="info" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      
      <Panel title="Research Labs Breakdown Chart" description="Quantitative research metrics across departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Research Labs Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Lab Name</th><th className="p-3">Department</th><th className="p-3">Faculty Incharge</th><th className="p-3">Supercomputing Nodes</th><th className="p-3">Running Projects</th><th className="p-3">Status</th>
                </tr>
              </thead>
