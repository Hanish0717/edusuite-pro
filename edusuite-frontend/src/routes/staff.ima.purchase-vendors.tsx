...
export const Route = createFileRoute("/staff/ima/purchase-vendors")({
  head: () => ({
    meta: [{ title: "Purchase Vendors — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Purchase Vendors</h1>
          <p className="text-sm text-muted-foreground">Registered hardware vendors, GST numbers, and procurement records.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Registered Vendors" value="16 Vendors" icon={FlaskConical} tone="purple" />
        <KpiCard label="GST Compliant" value="100%" icon={Cpu} tone="success" />
        <KpiCard label="Tier-1 OEM" value="Certified" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Purchase Vendors Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Vendor Code</th><th className="p-3">Company Name</th><th className="p-3">GST Number</th><th className="p-3">Supply Category</th><th className="p-3">Contact Email</th><th className="p-3">Status</th>
                </tr>
              </thead>
