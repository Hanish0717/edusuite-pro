...
export const Route = createFileRoute("/staff/finance-dean/vendor-payments")({
  head: () => ({
    meta: [{ title: "Vendor Payments — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Authorized vendor payments, GST invoices, and scheduled bank transfers.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Pending Vendor Payments" value="₹18.4 Lacs" icon={Wallet} tone="purple" />
        <KpiCard label="Cleared Payments" value="₹1.85 Cr" icon={CreditCard} tone="success" />
        <KpiCard label="SLA Pass" value="99.0%" icon={TrendingUp} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Vendor Payments Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Bill No</th><th className="p-3">Vendor Name</th><th className="p-3">Supply Category</th><th className="p-3">GST Invoice No</th><th className="p-3">Invoice Amount</th><th className="p-3">Payment Due Date</th><th className="p-3">Status</th>
                </tr>
              </thead>
