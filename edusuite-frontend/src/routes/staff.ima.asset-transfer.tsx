...
export const Route = createFileRoute("/staff/ima/asset-transfer")({
  head: () => ({
    meta: [{ title: "Asset Transfer — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Asset Transfer</h1>
          <p className="text-sm text-muted-foreground">Inter-departmental and inter-laboratory hardware transfer logs.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Transfers Year" value="18 Items" icon={FlaskConical} tone="purple" />
        <KpiCard label="Approved" value="100%" icon={Cpu} tone="success" />
        <KpiCard label="Location Audit" value="Verified" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Asset Transfer Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Transfer Ref</th><th className="p-3">Equipment Name</th><th className="p-3">Source Lab</th><th className="p-3">Destination Lab</th><th className="p-3">Transfer Date</th><th className="p-3">Approved By</th><th className="p-3">Status</th>
                </tr>
              </thead>
