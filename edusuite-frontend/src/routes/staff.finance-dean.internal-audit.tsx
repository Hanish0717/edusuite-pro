...
export const Route = createFileRoute("/staff/finance-dean/internal-audit")({
  head: () => ({
    meta: [{ title: "Internal Audit — Finance Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Internal Audit</h1>
          <p className="text-sm text-muted-foreground">Quarterly internal audit observations, voucher verifications, and compliance.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Audits Completed" value="Q2 Audited" icon={Wallet} tone="purple" />
        <KpiCard label="Vouchers Verified" value="2,480 Vouchers" icon={CreditCard} tone="success" />
        <KpiCard label="Audit Rating" value="Grade A" icon={TrendingUp} tone="info" />
        <KpiCard label="Status" value="Verified" icon={ShieldCheck} tone="warning" />
      </div>

      
      <Panel title="Internal Audit Distribution Chart" description="Quantitative financial ledger across academic departments.">
        <GroupedBarChart
          data={[
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Internal Audit Master Ledger" description="Official institutional financial ledgers, audit vouchers, and budget allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Audit ID</th><th className="p-3">Quarter</th><th className="p-3">Internal Auditor Name</th><th className="p-3">Scope</th><th className="p-3">Audit Date</th><th className="p-3">Observations</th><th className="p-3">Status</th>
                </tr>
              </thead>
