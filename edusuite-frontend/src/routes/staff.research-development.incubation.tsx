...
export const Route = createFileRoute("/staff/research-development/incubation")({
  head: () => ({
    meta: [{ title: "Startups & Incubation — R&D Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Startups & Incubation</h1>
          <p className="text-sm text-muted-foreground">Campus innovation incubator, seed funding, and incubated startups.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Incubated Startups" value="8 Startups" icon={FolderGit2} tone="purple" />
        <KpiCard label="Seed Funding" value="₹1.20 Cr" icon={BookOpen} tone="success" />
        <KpiCard label="Jobs Created" value="45 Jobs" icon={Award} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Startups & Incubation Master Ledger" description="Official institutional research projects, publications, grants, and patent dossiers.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Startup Name</th><th className="p-3">Founders</th><th className="p-3">Domain Focus</th><th className="p-3">Incubation Stage</th><th className="p-3">Seed Grant</th><th className="p-3">Status</th>
                </tr>
              </thead>
