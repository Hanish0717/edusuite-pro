...
export const Route = createFileRoute("/staff/examination-dean/exam-reports")({
  head: () => ({
    meta: [{ title: "Exam Reports — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Exam Reports</h1>
          <p className="text-sm text-muted-foreground">Master examination statistics, hall utilization, and invigilator attendance reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Reports Archived" value="18 Reports" icon={Users} tone="purple" />
        <KpiCard label="Audit Clearance" value="100%" icon={Calendar} tone="success" />
        <KpiCard label="Compliance Pass" value="100%" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Exam Reports Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
