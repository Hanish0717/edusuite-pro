...
export const Route = createFileRoute("/staff/placement-dean/drives")({
  head: () => ({
    meta: [{ title: "Placement Drives Schedule — EduSuite Pro" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Placement Drives Schedule</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Drives Completed" value="78 Drives" icon={Building2} tone="info" />
        <KpiCard label="Upcoming Drives" value="12 Drives" icon={Users} tone="success" />
        <KpiCard label="Eligible Students" value="840 Students" icon={ShieldCheck} tone="purple" />
        <KpiCard label="Status" value="Active" icon={CheckCircle2} tone="warning" />
      </div>

      {/* FILTERABLE MAIN TABLE */}
      <Panel title="Placement Drives Schedule Ledger" description="Official domain records & ERP status.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Recruiter Company</th><th className="p-3">Drive Date</th><th className="p-3">Eligible Students</th><th className="p-3">Status</th>
                </tr>
              </thead>
