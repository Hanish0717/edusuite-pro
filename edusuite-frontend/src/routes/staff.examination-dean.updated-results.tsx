...
export const Route = createFileRoute("/staff/examination-dean/updated-results")({
  head: () => ({
    meta: [{ title: "Updated Results — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Updated Results</h1>
          <p className="text-sm text-muted-foreground">Post-revaluation revised marks memo and updated CGPA transcripts.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Revised Memos" value="7 Issued" icon={Users} tone="purple" />
        <KpiCard label="CGPA Updated" value="100%" icon={Calendar} tone="success" />
        <KpiCard label="Portal Released" value="Active" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Updated Results Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Roll Number</th><th className="p-3">Student Name</th><th className="p-3">Subject Code</th><th className="p-3">Old Grade</th><th className="p-3">New Grade</th><th className="p-3">Updated CGPA</th><th className="p-3">Status</th>
                </tr>
              </thead>
