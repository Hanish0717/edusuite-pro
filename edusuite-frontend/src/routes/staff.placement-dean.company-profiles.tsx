...
export const Route = createFileRoute("/staff/placement-dean/company-profiles")({
  head: () => ({
    meta: [{ title: "Company Profiles — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Corporate recruiter profiles, job descriptions, eligibility criteria, and CTC perks.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Profiles Active" value="142 Profiles" icon={Building2} tone="purple" />
        <KpiCard label="Tier 1 Dream" value="32 Recruiters" icon={Users} tone="success" />
        <KpiCard label="JD Verified" value="100%" icon={Briefcase} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Company Profiles Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Company Name</th><th className="p-3">Job Role</th><th className="p-3">Min CGPA Criteria</th><th className="p-3">Bond Period</th><th className="p-3">Base Pay CTC</th><th className="p-3">Selection Process</th><th className="p-3">Status</th>
                </tr>
              </thead>
