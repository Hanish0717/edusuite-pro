...
export const Route = createFileRoute("/staff/examination-dean/question-paper-approval")({
  head: () => ({
    meta: [{ title: "Question Paper Approval — Examination Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Question Paper Approval</h1>
          <p className="text-sm text-muted-foreground">Board of Studies (BOS) question paper moderation & approval ledger.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="BOS Approved" value="184 Papers" icon={Users} tone="purple" />
        <KpiCard label="Syllabus Match" value="100% Verified" icon={Calendar} tone="success" />
        <KpiCard label="Moderator Rating" value="Grade A" icon={Ticket} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Question Paper Approval Master Ledger" description="Official Controller of Examinations records, schedules, marks entries, and hall allocations.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Subject Code</th><th className="p-3">Subject Title</th><th className="p-3">BOS Moderator</th><th className="p-3">Approval Date</th><th className="p-3">Difficulty Index</th><th className="p-3">Status</th>
                </tr>
              </thead>
