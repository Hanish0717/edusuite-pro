...
export const Route = createFileRoute("/staff/iqac/best-practices")({
  head: () => ({
    meta: [{ title: "Best Practices — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Best Practices</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="NAAC Best Practices" value="2 Distinctive Practices" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Impact Metric" value="100% Student Reach" icon={ShieldCheck} tone="success" />
        <KpiCard label="Review Status" value="Verified" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Best Practices Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Practice ID</th><th className="p-3">Title of Best Practice</th><th className="p-3">Focus Area</th><th className="p-3">Impact Metric</th><th className="p-3">Status</th>
                </tr>
              </thead>
