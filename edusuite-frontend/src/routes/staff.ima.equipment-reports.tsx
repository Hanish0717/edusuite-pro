...
export const Route = createFileRoute("/staff/ima/equipment-reports")({
  head: () => ({
    meta: [{ title: "Equipment Reports — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Equipment Reports</h1>
          <p className="text-sm text-muted-foreground">Hardware inventory health, working vs damaged ratios, and SLA reports.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Equipment SLA" value="95.1% Operational" icon={FlaskConical} tone="purple" />
        <KpiCard label="Total Assets" value="1,240 Assets" icon={Cpu} tone="success" />
        <KpiCard label="Audit Pass" value="100%" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Equipment Reports Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Report Title</th><th className="p-3">Asset Count</th><th className="p-3">Working Rate</th><th className="p-3">Status</th>
                </tr>
              </thead>
