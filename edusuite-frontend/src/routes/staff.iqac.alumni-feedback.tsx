...
export const Route = createFileRoute("/staff/iqac/alumni-feedback")({
  head: () => ({
    meta: [{ title: "Alumni Feedback — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Alumni Feedback</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Alumni Rating" value="4.85 / 5" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Curriculum Score" value="95.2%" icon={ShieldCheck} tone="success" />
        <KpiCard label="Respondents" value="640 Alumni" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Alumni Feedback Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Graduation Batch</th><th className="p-3">Total Alumni</th><th className="p-3">Response Count</th><th className="p-3">Curriculum Rating</th><th className="p-3">Status</th>
                </tr>
              </thead>
