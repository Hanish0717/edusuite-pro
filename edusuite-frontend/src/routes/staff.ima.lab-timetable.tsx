...
export const Route = createFileRoute("/staff/ima/lab-timetable")({
  head: () => ({
    meta: [{ title: "Lab Timetable — IMA Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Lab Timetable</h1>
          <p className="text-sm text-muted-foreground">Weekly laboratory schedules, occupied slots, and free lab sessions.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Weekly Sessions" value="140 Hours" icon={FlaskConical} tone="purple" />
        <KpiCard label="Occupancy Rate" value="84.2%" icon={Cpu} tone="success" />
        <KpiCard label="Free Slots" value="22 Slots" icon={Wrench} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Lab Timetable Master Ledger" description="Official institutional equipment, laboratory, and asset inventory records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Day</th><th className="p-3">Period</th><th className="p-3">Laboratory</th><th className="p-3">Department</th><th className="p-3">Subject / Batch</th><th className="p-3">Faculty Incharge</th><th className="p-3">Status</th>
                </tr>
              </thead>
