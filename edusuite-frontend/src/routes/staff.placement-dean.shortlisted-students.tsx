...
export const Route = createFileRoute("/staff/placement-dean/shortlisted-students")({
  head: () => ({
    meta: [{ title: "Shortlisted Students — Placement Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Shortlisted Students</h1>
          <p className="text-sm text-muted-foreground">Round-wise student shortlists for interview rounds.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Shortlisted" value="1,420 Students" icon={Building2} tone="purple" />
        <KpiCard label="Shortlist Ratio" value="78.0%" icon={Users} tone="success" />
        <KpiCard label="Interviews Booked" value="100%" icon={Briefcase} tone="info" />
        <KpiCard label="Status" value="Shortlisted" icon={Award} tone="warning" />
      </div>

      

      {/* MAIN DATA TABLE */}
      <Panel title="Shortlisted Students Master Ledger" description="Official Corporate Relations & Placement Cell ledgers, student selections, and drive details.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Student Name</th><th className="p-3">Roll Number</th><th className="p-3">Department</th><th className="p-3">Company</th><th className="p-3">Shortlisted Round</th><th className="p-3">Status</th>
                </tr>
              </thead>
