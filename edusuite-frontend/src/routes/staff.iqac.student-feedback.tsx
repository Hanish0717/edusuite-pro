...
export const Route = createFileRoute("/staff/iqac/student-feedback")({
  head: () => ({
    meta: [{ title: "Student Feedback — IQAC Dean" }],
  }),
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-4">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Student Feedback</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard label="Response Rate" value="94.2%" icon={BadgeCheck} tone="purple" />
        <KpiCard label="Avg Rating" value="4.78 / 5" icon={ShieldCheck} tone="success" />
        <KpiCard label="Respondents" value="4,850 Students" icon={FileText} tone="info" />
      ...
      {/* MAIN DATA TABLE */}
      <Panel title="Student Feedback Ledger" description="Official NAAC, NBA & Institutional Quality Records.">
          ...
          <div className="overflow-x-auto border border-border rounded-xl">
            <table className="w-full text-left text-xs">
              <thead className="border-b border-border bg-muted/40 font-semibold uppercase tracking-wider text-muted-foreground">
                <tr>
                  <th className="p-3">Semester</th><th className="p-3">Department</th><th className="p-3">Total Students</th><th className="p-3">Response Rate</th><th className="p-3">Avg Rating</th><th className="p-3">Status</th>
                </tr>
              </thead>
